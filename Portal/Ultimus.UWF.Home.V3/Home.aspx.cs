...
namespace Ultimus.UWF.Home.V3
{
    public partial class Home : System.Web.UI.Page
    {
        ...
        string GetFilter(out List<ParameterEntity> table)
        {
            ...
            table.Add(new ParameterEntity("STARTTIME", ConvertUtil.ToShortDateString(startTime)));
            table.Add(new ParameterEntity("ENDTIME", ConvertUtil.ToShortDateString(endTime)));
