<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SelectSignedApprover.aspx.cs" Inherits="Ultimus.UWF.OrgChart.SelectSignedApprover" %>
            ...
            $("#grid").jqxGrid(
                {
                    ...
                    columns: [
                        { text: '中文名称', datafield: 'USERNAME', width: '24%' },
                        { text: '英文名称', datafield: 'LOGINNAME', width: '40%' },
                        { text: '职位', datafield: 'JOBFUNCTION', width: '18%' },
                        { text: '类型', datafield: 'EXT30', width: '18%' }
                    ]
                        ...
                        $("#gridsel").jqxGrid(
                            {
                                ...
                                columns: [
                                    { text: '中文名称', datafield: 'USERNAME', width: '24%' },
                                    { text: '英文名称', datafield: 'ACCOUNT', width: '40%' },
                                    { text: '职位', datafield: 'JOBFUNCTION', width: '18%' },
                                    { text: '类型', datafield: 'EXT30', width: '18%' }
                                ]
                            });
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <asp:DropDownList ID="ddlType" runat="server" Width="100%" ToolTip="选择类型">
                ...
                <div class="col-xs-8">
                    <div class="input-prepend input-group">
                        <input name="txtSearch" type="text" value="" id="txtSearch" class="form-control" placeholder="输入关键字进行搜索" />
                ...
                <div class="col-xs-12">
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="col-xs-8" style="text-align: right">
                            ...
                            <a onclick="if(confirm('您是否要删除?')){return delSel();}return false;"
                                class="btn btn-icon btn-sm" title="删除">
