<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyTaskListBatch.aspx.cs" Inherits="Ultimus.UWF.Home.V3.MyTaskListBatch" %>
...
<body>
        ...
        <div class="form-content">
            ...
            <div class="page-header">
                ...
                <h1 class="title ">
                    ...
                    <%=Lang.Get("DEFAULT_MYTASK")%> - <%=Request["ProcessName"] %></h1>
                <%--  <ol class="breadcrumb">
                ...
                <div class="right">
                    <%--<div class="btn-group" role="group" aria-label="...">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a onclick="javascript:assign();"><i class="fa fa-share padding-r-5"></i><%=Lang.Get("TaskList_Assign") %></a></li>
                            <li><a onclick="javascript:delegation();"><i class="fa fa-history padding-r-5"></i><%=Lang.Get("Delegation") %></a></li>
                            <li><a href="AssignmentList.aspx" ><i class="fa fa-reply padding-r-5"></i><%=Lang.Get("TaskList_AssignCallback")%></a></li>
                            <li class="divider hidden"></li>
                            <li class="hidden"><a href="javascript:changeStatus();"><i class="fa fa-check-square-o padding-r-5"></i><%=Lang.Get("SelectAll")%></a></li>
                        </ul>
                    ...
                    <div class="btn-group" role="group" aria-label="...">
                        <a onclick="javascript:batchapproval();" class="btn btn-light"><i class="fa fa-share padding-r-5"></i><%=Lang.Get("TaskList_ApproveBatch") %></a>
                        <a href="javascript:location.href=location.href;" class="btn btn-light"><i class="fa fa-refresh"></i></a>
                        <a onclick="$('#searchPanel').toggle();" class="btn btn-light"><i class="fa fa-search"></i></a>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        function batchapproval() {
            if (!confirm("<%=Lang.Get("ConfirmApprove")%>"))
            {
                return false;
            }
            ...
            $.post(
                "handler/TaskBatch.ashx",
                { method: 'TaskBatch', taskId: taskid },
