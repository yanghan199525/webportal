<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyDelegationConfirmApproval.aspx.cs" Inherits="Ultimus.UWF.Home.V3.MyDelegationConfirmApproval" %>
...
<body>
    <form id="form1" runat="server">
        <div id="content" class="form-content">
            <h3><asp:Label ID="label_info" runat="server">代理信息审批</asp:Label></h3>
            <hr style="height: 1px; border: none; border-top: 1px solid black;" />
            <div id="nav">
                <h5><asp:Label ID="label_txtUser" runat="server">尊敬的用户</asp:Label><asp:Label ID="approvalName" runat="server"></asp:Label>，
                    <asp:Label ID="label_txtTaskUser" runat="server">有一个流程代理需要您审批</asp:Label>
             
                </h5>
                <p><asp:Label ID="label1" runat="server">1.被代理人：</asp:Label><asp:Label ID="assignUser" runat="server"></asp:Label></p>
                <p><asp:Label ID="label2" runat="server">1.代理人：</asp:Label><asp:Label ID="taskUser" runat="server"></asp:Label></p>
