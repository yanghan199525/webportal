<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Assign.aspx.cs" Inherits="Ultimus.UWF.Home.V3.Assign" %>
...
<head id="Head1" runat="server">
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=98ce35d9-80fd-44a9-b648-7142364bdb01'></script>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="TableData" width="98%">
                ...
                <tr class="TableDataRow <%=onlyselect%>" style="text-align: left; height: 20px;">
                    <td>
                ...
                <tr class="TableDataRow hidden" style="text-align: left; height: 20px;">
                    ...
                    <td>
                        <label for="RadioButton3" style="cursor: pointer;">
                            <%=Lang.Get("Assign_FutureTaskAssign")%>
                        </label>
                    </td>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <table cellpadding="2">
                            <tr idx="trprocessname" class="TableDataRow" style="display: none;">
                ...
                <tr>
                    ...
                    <input id="AssignUserName" style="width: 200px;" runat="server" class="TextSearch" onfocus="this.blur();" />
                        <input type="button" value="..." class="btn Button" onclick="parent.selectUserInfo(2, $('#AssignUserName').attr('id'), '', $('#AssignUserAccount').attr('id'), null, true);" />
                ...
                <tr class="TableDataRow" style="text-align: left; height: 20px;">
                    <td colspan="2" align="center">
                        ...
                        <a href="AssignmentList.aspx" class="btn" target="_blank"><%=Lang.Get("btn_RecallTask")%></a>
                        <script type="text/javascript">
                            function CheckPage() {
                                var flag = true;
