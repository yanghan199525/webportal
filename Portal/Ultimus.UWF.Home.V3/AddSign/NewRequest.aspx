            ...
            <table style="width: 100%; margin-top: 3px;">
                ...
                <tr>
                    ...
                    <td class="td-content" colspan="3">
                        ...
                        <input type="button" runat="server" id="selectuser" class="btn btn-default" style="margin-bottom: 5px;" value="选择 Select" onclick="parent.selectUserInfo(2, 'txtJiaqianName', 'txtJiaqianId', '', null, true);" />
                    </td>
                </tr>
