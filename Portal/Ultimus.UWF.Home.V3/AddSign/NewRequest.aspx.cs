    ...
    public partial class NewRequest : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                txtJiaQianProcessName.Text = ProcessName;
            }
        }
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        if (jsonObj != null)
                        {
                            ...
                            string ProcessNameCN = ConvertUtil.ToString(DataAccess.Instance("BizDB").ExecuteScalar("select CNNAME from WF_PROCESS where processname=N'" + txtJiaQianProcessName.Text.Trim() + "'"));
                            if (!string.IsNullOrEmpty(ConvertUtil.ToString(jsonObj["summary"])))
                                SUMMARY = " ( " + ProcessNameCN.Trim() + " ) " + ConvertUtil.ToString(jsonObj["summary"]);
                            ...
                            listParm.Add("applicant", ue.CNNAME);
                ...
                DataAccess.Instance("BizDB").ExecuteNonQuery(sql, FORMID, txtJiaQianProcessName.Text, 0, ue.CNNAME,
