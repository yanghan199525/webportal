...
<div class="form-content" style="padding-top: 0px">
    <div class="container-default">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default" style="border: 0px;padding-top: 0px">
                    <div class="panel-body " style="text-align:center">
                        <asp:Button ID="btnSubmit" runat="server" CssClass="btn btn-default hidden" Text="提交" OnClientClick=""
                            OnClick="btnSubmit_Click" />
                        <asp:Button ID="btnSend" runat="server" CssClass="btn btn-default" Text="提交" OnClientClick="return submitForm();"
                            OnClick="btnSubmit_Click" />
                        &nbsp;&nbsp;&nbsp;&nbsp;
    <%--<asp:Button ID="btnSaveDraft" runat="server" CssClass="btn "  Text="保存草稿" OnClientClick="showDiv();"
        OnClick="btnSaveDraft_Click" />--%>

                        <asp:Button ID="btnClose" runat="server" Text="关闭" CssClass="btn btn-success" OnClientClick="return closeWin();" />
                    </div>
                </div>
            </div>
        </div>
