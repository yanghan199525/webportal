<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportListV7.aspx.cs" Inherits="Ultimus.UWF.Home.V3.ReportListV7" %>
...
<body>
    ...
    <script type="text/javascript">
        function openForm(processName, ele) {
            ...
            //s.focus();
            let url = '../../Solution/'+processName+'/ReportV7/ReportListV7.aspx';
            location.href = url;
        }
