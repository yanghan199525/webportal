<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailNotification.aspx.cs" Inherits="Ultimus.UWF.Home.V3.EmailNotification" %>
...
<body>
            <div style="margin-left:5%"> <h4> <span class="btn btn-rounded btn-default btn-icon cursor-default"> <i class="fa fa-envelope-o"></i></span> 月度通知人维护列表</h4></div>
     ...
     <form id="form1" runat="server" style="width:100%">
        <div class="container">
            ...
            <div class="row" style="margin-top:2%">
                <div class="col-lg-4" >
                   <span style="font-size:16px;padding-right:3%">用户名:</span>
                      <asp:TextBox ID="txt_UserName" runat="server"  Destination="UserName" Width="70%" Height="30px"></asp:TextBox>
                </div>
                <div class="col-lg-4" style="text-align:left">
                     <span style="font-size:16px;padding-right:3%">分店编号:</span>
                      <asp:TextBox ID="txt_CXCode" data-type="string" runat="server" Destination="CXCode" Width="70%" Height="30px">
                            </asp:TextBox>
                </div>
                <div class="col-lg-4">
