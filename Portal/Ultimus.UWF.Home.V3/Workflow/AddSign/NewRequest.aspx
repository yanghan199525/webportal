            ...
            <table style="width: 100%; margin-top: 3px;">
                ...
                <tr>
                    <td class="labelTD" style="width: 15%">
                        ...
                        <%=Lang.Get("Countersigning_Officer") %>:
                    </td>
                    <td class="td-content" colspan="3">
                        ...
                        <input type="button" runat="server" id="selectuser" class="btn btn-default" style="margin-bottom: 5px;" value="选择 Select" onclick="parent.addSelectUserInfo(2, 'txtJiaqianName', 'txtJiaqianId', '', null, true);" />
                    </td>
                </tr>
                <tr id="trIdear" runat="server">
                    <td class="labelTD">
                        <%=Lang.Get("Countersigning_Information") %>：
                    </td>
                    <td class="td-content" colspan="3">
