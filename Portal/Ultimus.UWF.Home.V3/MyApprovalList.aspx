<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyApprovalList.aspx.cs" Inherits="Ultimus.UWF.Home.V3.MyApprovalList" %>
...
<head>
    ...
    <title><%=Lang.Get("title_MyApprovalList") %></title>
...
<body>
    <form id="form1" runat="server">
        <div class="form-content">
            ...
            <div class="page-header">
                ...
                <h1 class="title ">
                    <span class="btn btn-rounded btn-default btn-icon cursor-default"><i class="fa fa-check-square-o"></i></span>
                    <%=Lang.Get("MyApproval") %></h1>
                <%--   <ol class="breadcrumb">
                                        ...
                                        <div class="col-md-4 col-sm-6 col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7  col-xs-7">
                                                    ...
                                                    <asp:DropDownList ID="ddlProcessName" runat="server" CssClass="form-control"
                                                        AutoPostBack="true" OnSelectedIndexChanged="ddlProcessName_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <thead>
                                        <tr>
                                            <td class="text-center  hidden" data-orderable="false">
                                                <input id="Checkbox1" type="checkbox" onclick="selectAll('tasklist', this)" hidden="hidden" />
    ...
    <script type="text/javascript">
        ...
        //    let url = 'Workflow/OpenForm.aspx?TaskId=' + taskId + '&Type=MYAPPROVAL&ServerName=' + serverName + '&ProcessName=' + encodeURI(processName) + '&StepName=' + encodeURI(stepName);
        //    location.href = url;
        ...
        function openForm(taskId, type, serverName, processName, stepName, ele) {
            ...
            s = window.open('Workflow/OpenForm.aspx?TaskId=' + taskId + '&Type=MYAPPROVAL&ServerName=' + serverName + '&ProcessName=' + encodeURI(processName) + '&StepName=' + encodeURI(stepName), '', winoption);
            s.focus();
