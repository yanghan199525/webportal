...
{
    public partial class JdJump01 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string url = string.Format("{0}/Portal/Ultimus.UWF.Home.V3/JdNewRequest.aspx?uid={1}&submitOrderTime={2}&orderId={3}&totalMoney={4}&freight={5}&sign={6}&platType=1", path,uid,submitOrderTime,orderId,totalMoney,freight,sign);
