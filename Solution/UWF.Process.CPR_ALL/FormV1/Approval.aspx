<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="UWF.Process.CPR_ALL.Approval" %>
...
<head>
    ...
    <script runat="server">
        ...
        {
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_CPR_ALL_ITEMS = Page.FindControl("read_detail_PROC_CPR_ALL_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            read_detail_PROC_CPR_ALL_ITEMS.AfterBind += new System.EventHandler(AfterBind);
            AfterLoad();
        }
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_CPR_ALL_ITEMS = Page.FindControl("read_detail_PROC_CPR_ALL_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if (read_detail_PROC_CPR_ALL_ITEMS.Items.Count == 0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, read_detail_PROC_CPR_ALL_ITEMS, 1);
            }
        }
