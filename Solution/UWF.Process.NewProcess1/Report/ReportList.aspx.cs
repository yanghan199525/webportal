...
namespace UWF.Process.NewProcess1
{
    ...
    rpt.Source = "BizDB.select * from PROC_NEWPROCESS1 where 1=1 "+process.GetReportViewSql    ("NewProcess1",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("NewProcess1");
    ExcelUtil.Export(dt);
    }
