...
<body>
   ...
   tablenamedetail="PROC_ITEM" runat="server"></ui:userinfo>
                        ...
                        <div class="panel-body form-table">
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_PRODUCTNO" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_PRODUCTNO" data-type='string' title="" onblur="" data-field="PRODUCTNO"   Variable="" ControlValue="" CssClass="form-control validate[required]  border-left-color" runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class=" td_VENDORCODE" data-label='<%=Lang.Get("UWF.Process.NewProcess1.VendorCode").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_VENDORCODE" title="" data-type='string' onblur=""  data-field="VENDORCODE" CssClass="item-control  " ControlValue='<%#Eval("VENDORCODE")%>' runat="server">
                                                </ult:TextBox>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=b0bb9b26-0a3e-4602-adf1-3391d101842f'></script>
    <script type='text/javascript' src='NewRequest.js?t=85ca4dc4-6498-49e9-9384-2297b471f4b7'></script>
</body>
</html>
