...
<head>
    ...
    <script runat="server">
        ...
        {
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_ITEM = Page.FindControl("read_detail_PROC_ITEM") as Ultimus.UWF.Form.WebControls.Repeater;
            read_detail_PROC_ITEM.AfterBind += new System.EventHandler(AfterBind);
            AfterLoad();
        }
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_ITEM = Page.FindControl("read_detail_PROC_ITEM") as Ultimus.UWF.Form.WebControls.Repeater;
            if(read_detail_PROC_ITEM.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, read_detail_PROC_ITEM,1);
            }
        }
...
<body>
   ...
   tablenamedetail="PROC_ITEM" runat="server"></ui:userinfo>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_PRODUCTNO" style="height:">
                                        ...
                                        <%=Lang.Get("UWF.Process.NewProcess1.ProductNo") %>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_PRODUCTNO" title="" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <table id="tb_ITEM" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class=" td_VENDORCODE" data-label='<%=Lang.Get("UWF.Process.NewProcess1.VendorCode").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_VENDORCODE" title="" data-type='string' data-field="VENDORCODE" runat="server" Text='<%#Eval("VENDORCODE")%>' Format="" Width="90%"></ult:Label>
                                        </td> 
                                            <td>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=684bd8c4-dc88-41eb-8ea2-380f881b5733'></script>
    <script type='text/javascript' src='Approval.js?t=7420cdf5-eb1f-4ec6-9fda-2a6e4928ac89'></script>
</body>
</html>
