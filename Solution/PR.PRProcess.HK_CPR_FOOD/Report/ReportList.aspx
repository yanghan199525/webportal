<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="PR.PRProcess.HK_CPR_FOOD.ReportList" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    ...
                    <tbody>
                        <ult:Repeater ID="rptList" Source="BizDB.PROC_HK_CPR_FOOD" PagerID="AspNetPager1"
                            runat="server">
                            <itemtemplate>
                                <tr>
                                    <td>
                            ...
                            <itemtemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%#Eval("PROCESSNAME").ToString()=="HK_CPR_FOOD"?"食品":Eval("PROCESSNAME").ToString()=="HK_CPR_NONFOOD"?"非食品":"服务"%>
                                    </td>
                                    <td>
                                        <%#Eval("SUPPLIERCODE")%>
                                    </td>
