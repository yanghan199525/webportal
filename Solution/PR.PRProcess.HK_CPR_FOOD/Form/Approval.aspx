<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="PR.PRProcess.HK_CPR_FOOD.Approval" %>
...
<body>
     ...
     <ui:userinfo id="UserInfo1" processtitle="HK_CPR_FOOD" processpefix="HK_CPR" tablename="PROC_HK_CPR_FOOD"
        ...
        <!--1.对Table做循环，判断单行,多行-->
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.APPREMARK") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SignedApprover" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.USER_SignedApprover") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SignedApprover2" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.USER_SignedApprover2") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SignedApprover3" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.USER_SignedApprover3") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_HK_CPR_FOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
    ...
    <script type='text/javascript' src='Approval.js?t=69e13ae1-9f6d-4b8c-bb42-ed7980096345'></script>
