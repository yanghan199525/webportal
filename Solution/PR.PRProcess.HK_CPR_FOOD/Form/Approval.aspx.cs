...
namespace PR.PRProcess.HK_CPR_FOOD
{
    public partial class Approval : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
          ...
          // this.read_USER_SIGNEDAPPROVERNAME2.Text= GetSignedApprover(Incident);
        ...
        public string getDeliveryDate(string ProcessName, string Incident, string TaskID)
        {
            ...
            try
            {
                ...
                {
                    DataTable PROC_HK_CPR_FOOD = DataAccess.Instance("BizDB").ExecuteDataTable("SELECT * FROM PROC_HK_CPR_FOOD WHERE PROCESSNAME='" + ProcessName + "' AND INCIDENT=" + Incident);
                    if (PROC_HK_CPR_FOOD != null)
                    {
                        DeliveryDate = PROC_HK_CPR_FOOD.Rows[0]["DELIVERYDATE"].ToString();
                    }
                }
                return DeliveryDate;
            }
