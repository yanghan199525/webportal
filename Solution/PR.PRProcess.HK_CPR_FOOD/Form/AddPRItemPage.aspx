<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPRItemPage.aspx.cs" Inherits="PR.PRProcess.HK_CPR_FOOD.AddPRItemPage" %>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD_Items") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.APPLYREASON") %><span style='color: red'>*</span>:
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.FAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.SUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.SUBSUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.SUPPLIERNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.SUPPLIERCODE") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_HISTORYARTICLELIST" style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.ARTICLENAME") %>:--%>
                                    <%=Lang.Get("PPR.PRProcess.HK_CPR_FOOD.HISTORYARTICLELIST") %>:
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.OTHERARTICLENAME") %>:--%>
                                    <%--其他物品名称:--%>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.ARTICLENAME") %>:
                                </div>
                                <div class="form-field">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.UNITINFORMATION") %>
                                <%--单位--%>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.ORDERUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.UNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.CONSUMPTIONUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.CONVERSION") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12 form-cell " id="div_field_STOCK" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.STOCK") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">  
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.NETVOMULE") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    ...
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.NETVOMULEUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_GROSSWEIGHT" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.GROSSWEIGHT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.GROSSWEIGHTUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-title">
                                <div class="fa-title">
                                    <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.ORDERINGINFORMATION") %>
                                    <%--采购信息--%>
                                </div>
                            ...
                            <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.SITEPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_NETNETPRICE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.NETNETPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_FOOD.ORDERQUANTITY") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
    ...
    <script type='text/javascript' src='AddPRItemPage_.js?t=7a9a1d87-03c3-4f71-887c-881c7141327'></script>
