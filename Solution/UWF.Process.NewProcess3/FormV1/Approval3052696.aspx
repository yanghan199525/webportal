<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval3052696.aspx.cs" Inherits="UWF.Process.NewProcess3.Approval3052696" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="NewProcess3" processpefix="" tablename="PROC_NEWPROCESS3"
   tablenamedetail="" runat="server"></ui:userinfo>
            ...
            <!--1.对Table做循环，判断单行,多行-->
            <!--1.1单行-->
            <div class="row" id="div_panel_NewProcess3">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("UWF.Process.NewProcess3.NewProcess3") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CREATER" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_CREATER" title="" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_EMPNO" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_EMPNO" title="" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CTEATEDATE" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_CTEATEDATE" title="" data-type='date' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=5ce66b00-36ab-4dee-9285-72b1a0d0c14e'></script>
    <script type='text/javascript' src='Approval3052696.js?t=03a49648-177b-4656-b456-89dba8f10844'></script>
</body>
</html>
