...
<body>
                        ...
                        <div class="panel-body form-table">
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CREATER" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_CREATER" data-type='string' title="" onblur="" data-field="CREATER"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_EMPNO" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_EMPNO" data-type='string' title="" onblur="" data-field="EMPNO"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <div class="input-prepend input-group">
                                                        ...
                                                        <span class="add-on input-group-addon" style="border-left:0" onclick="$(this.previousElementSibling).click()"><i class="fa fa-calendar"></i></span>
                                                        <span class="add-on input-group-addon" onclick="this.parentNode.firstElementChild.value=''"><i class="fa fa-remove"></i></span>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_SUPPLIERTYPE" data-type='string' title="" onblur="" data-field="SUPPLIERTYPE"   Variable="SUPPLIERTYPE" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=26156c88-b44a-486c-9010-b1d3b624e363'></script>
    <script type='text/javascript' src='NewRequest.js?t=73c1a0aa-e621-4584-8c01-e20b064bce68'></script>
</body>
</html>
