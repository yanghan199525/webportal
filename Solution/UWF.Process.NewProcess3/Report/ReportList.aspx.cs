...
namespace UWF.Process.NewProcess3
{
    ...
    rpt.Source = "BizDB.select * from PROC_TESTING where 1=1 "+process.GetReportViewSql    ("NewProcess3",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("NewProcess3");
    ExcelUtil.Export(dt);
    }
