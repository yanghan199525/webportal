...
namespace UWF.Process.CAPEX_NONFOOD
{
    ...
    AAA.EXECUTIONDATE, AAA.ISALLOW, AAA.REASONS, AAA.SUPPLIERCODE, 
    AAA.SUPPLIERNAME, AAA.COMPANYCODE, AAA.TOTALAMOUNTORDER, 
    AAA.TOTALAMOUNTSUPPLIER, AAA.TOTALAMOUNTDIFFER, AAA.BATCHNUMBER, 
    AAA.STATECODE, AAA.APPROVE, AAA.PCCOMPCODE, AAA.PONumber, 
    AAA.POSiteCode, AAA.ISCHANGE,
    WF.ACTION
FROM [dbo].[PROC_PO_SUPPLIER_NETPRICE] AS AAA
...
";
        ...
        protected void lbExport_Click(object sender, EventArgs e)
        {
            ...
            dt = ExportLogic.GetSchemaTable("PO_SUPPLIER_NETPRICE", dt);
            ExcelUtil.Export(dt);
        }
    }
}