...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PO_SUPPLIER_NETPRICE" processprefix="PON" tablename="PO_SUPPLIER_NETPRICE"
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-8 col-sm-6 col-xs-12 form-cell " id="div_field_BATCHNUMBER" style="height: ">
                            <div class="form-label">
