<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="PR.PRProcess.PR_SERVICE.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PR_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_PR_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_PR_SERVICE_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PR_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_PR_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_PR_SERVICE_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_PR_SERVICE_ITEMS,1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PR_SERVICE" processprefix="PR" tablename="PROC_PR_SERVICE"
   tablenamedetail="PROC_PR_SERVICE_ITEMS" runat="server"></ui:userinfo>
            <!--End main table-->
            ...
            <!--1.对Table做循环，判断单行,多行-->
            <!--1.1单行-->
            <div class="row" id="div_panel_PR_SERVICE">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.PR_SERVICE.PR_SERVICE") %>
                            </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_DOCUMENTNO" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.DOCUMENTNO") %>:
             </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_PurchasingPurpose" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.PurchasingPurpose") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.SITECODE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.SITENAME") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DELIVERYDATE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.DELIVERYDATE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.AMOUNT") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_Requirement" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.Requirement") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-8 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.APPREMARK") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.APPROVEDATE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_SERVICE.APPROVE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
            ...
            <!--1.2多行-->
                    <!--Start Item table-->
            <div class="row" id="div_panel_PR_SERVICE_ITEMS">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("PR.PRProcess.PR_SERVICE.PR_SERVICE_ITEMS") %></div>
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PR_SERVICE_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                                        <input id="tb_PR_SERVICE_ITEMS_rowCount" type="text" runat="server" />
                                    </td>
                                    <td class="th_no" style="width:50px">
                                        <%=Lang.Get("No") %>
                                    </td>
                                    <td style=""  class="hidden td_ARTICLECODE"><%=Lang.Get("PR.PRProcess.PR_SERVICE.ARTICLECODE") %></td>
                                    <td style=""  class=" td_ARTICLENAME"><%=Lang.Get("PR.PRProcess.PR_SERVICE.ARTICLENAME") %></td>
                                    <td style=""  class="hidden td_SUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.PR_SERVICE.SUBSUBFAMILYCODE") %></td>
                                    <td style=""  class=" td_SUBSUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.PR_SERVICE.SUBSUBFAMILYNAME") %></td>
                                    <td style=""  class=" td_ORDERUNIT"><%=Lang.Get("PR.PRProcess.PR_SERVICE.ORDERUNIT") %></td>
                                    <td style=""  class=" td_SITEPRICE"><%=Lang.Get("PR.PRProcess.PR_SERVICE.SITEPRICE") %></td>
                                    <td style=""  class=" td_ORDERQUANTITY"><%=Lang.Get("PR.PRProcess.PR_SERVICE.ORDERQUANTITY") %></td>
                                    <td style=""  class=" td_SUBTOTALAMOUNT"><%=Lang.Get("PR.PRProcess.PR_SERVICE.SUBTOTALAMOUNT") %></td>
                                    <td style="width:60px"><%=Lang.Get("Action") %></td>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_PR_SERVICE_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td class="hidden td_ARTICLECODE" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.ARTICLECODE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ARTICLENAME" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.ARTICLENAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBSUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.SUBSUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SUBSUBFAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.SUBSUBFAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ORDERUNIT" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.ORDERUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SITEPRICE" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.SITEPRICE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ORDERQUANTITY" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.ORDERQUANTITY").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SUBTOTALAMOUNT" data-label='<%=Lang.Get("PR.PRProcess.PR_SERVICE.SUBTOTALAMOUNT").Split('<')[0] %>'>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PR_SERVICE_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_PR_SERVICE_ITEMS');return false;"
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
             ...
             $("#tb_PR_SERVICE_ITEMS").find("thead").find("td:last").addClass("hidden");
             $("#tb_PR_SERVICE_ITEMS").find("tbody").find("td:last").addClass("hidden");
