<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm.aspx.cs" Inherits="UWF.Process.CAPEX_SERVICE.PrintForm" %>
...
<body>
   ...
   tablenamedetail="PROC_CAPEX_SERVICE_ITEMS" runat="server"></ui:userinfo>
                <div class="panel  "><%=Lang.Get("UWF.Process.CAPEX_SERVICE.CAPEX_SERVICE") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                    <tr class="">
                        <td class="tdlbl tdl_SITECODE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.SITECODE") %>：</td>
                        <td class="tdtxt tdt_SITECODE">
                                                        <ult:Label ID="read_SITECODE"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_SITENAME"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.SITENAME") %>：</td>
                        <td class="tdtxt  tdt_SITENAME">
                                                        <ult:Label ID="read_SITENAME"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_CAPEXNUMBER"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.CapexNumber") %>：</td>
                        <td class="tdtxt tdt_CAPEXNUMBER">
                                                        <ult:Label ID="read_CAPEXNUMBER"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_SUPPLIERCODE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.SupplierCode") %>：</td>
                        <td class="tdtxt  tdt_SUPPLIERCODE">
                                                        <ult:Label ID="read_SUPPLIERCODE"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_SUPPLIERNAME"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.SupplierName") %>：</td>
                        <td class="tdtxt tdt_SUPPLIERNAME">
                                                        <ult:Label ID="read_SUPPLIERNAME"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_CONTRACTDATE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.ContractDate") %>：</td>
                        <td class="tdtxt  tdt_CONTRACTDATE">
                                                        <ult:Label ID="read_CONTRACTDATE"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_DEPRECIATIONDATE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.DepreciationDate") %>：</td>
                        <td class="tdtxt tdt_DEPRECIATIONDATE">
                                                        <ult:Label ID="read_DEPRECIATIONDATE"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_UPLOADS"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.Uploads") %>：</td>
                        <td class="tdtxt  tdt_UPLOADS">
                                                        <ult:Label ID="read_UPLOADS"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_AMOUNT"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.AMOUNT") %>：</td>
                ...
                <div class="panel  "><%=Lang.Get("UWF.Process.CAPEX_SERVICE.CAPEX_SERVICE_ITEMS") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="" class=" thlbl td_ARTICLECODE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.ArticleCode") %></td>
                    <td style="" class=" thlbl td_ARTICLENAME"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.ArticleName") %></td>
                    <td style="" class=" thlbl td_FAMILYNAME"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.FamilyName") %></td>
                    <td style="" class=" thlbl td_PCPRICE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.PCPrice") %></td>
                    <td style="" class=" thlbl td_ORDERQTY"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.OrderQty") %></td>
                    <td style="" class=" thlbl td_ORDERUNIT"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.OrderUnit") %></td>
                    <td style="" class=" thlbl td_AMOUNT"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.Amount") %></td>
                    <td style="" class=" thlbl td_DELIVERYDATE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.DeliveryDate") %></td>
                    <td style="" class=" thlbl td_NEEDACCEPT"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.NeedAccept") %></td>
                    <td style="" class=" thlbl td_ASSETCLASS"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.AssetClass") %></td>
                    <td style="" class=" thlbl td_ACCEPTMARK"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.AcceptMark") %></td>
                    <td style="" class=" thlbl td_STATECODE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.StateCode") %></td>
                    <td style="" class=" thlbl td_FAMILYCODE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.FamilyCode") %></td>
                    <td style="" class=" thlbl td_DEPRECIATIONSTARTDATE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.DepreciationStartDate") %></td>
                    <td style="" class=" thlbl td_BUYBACKTERM"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.BuybackTerm") %></td>
                    <td style="" class=" thlbl td_REMOVABLE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.Removable") %></td>
                    <td style="" class=" thlbl td_USEFULLIFE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.UsefulLife") %></td>
                    <td style="" class=" thlbl td_CONTRACTCLOSUREDATE"><%=Lang.Get("UWF.Process.CAPEX_SERVICE.ContractClosureDate") %></td>
                </tr>
                <ult:Repeater ID="read_detail_PROC_CAPEX_SERVICE_ITEMS" runat="server">
                  <ItemTemplate>
                    <tr>
