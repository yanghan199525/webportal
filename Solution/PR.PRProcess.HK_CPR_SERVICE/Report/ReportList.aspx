<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="PR.PRProcess.HK_CPR_SERVICE.ReportList" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    香港单外审批进度表/Hong Kong Out Of Catalogue Purchase Requisition Request Approval Progress</span>
            ...
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    ...
                    <tbody>
                        <ult:Repeater ID="rptList" Source="BizDB.PROC_HK_CPR_SERVICE" PagerID="AspNetPager1"
                            runat="server">
                            <itemtemplate>
                                <tr>
                                    <td>
            ...
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    香港单外审批草稿箱/Hong Kong Out Of Catalogue Purchase Requisition Request Drafts</span>
            </div>
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    <thead>
                            ...
                            <itemtemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%#Eval("PROCESSNAME").ToString()=="HK_CPR_SERVICE"?"食品":Eval("PROCESSNAME").ToString()=="HK_CPR_NONFOOD"?"非食品":"服务"%>
                                    </td>
                                    <td>
                                        <%#Eval("SUPPLIERCODE")%>
                                    </td>
                                    ...
                                    <td>
                                        <%#Eval("SUPPLIERTYPE").ToString()=="1"?"非授权供应商/Unauthorized Supplier":Eval("SUPPLIERTYPE").ToString()=="0"?"授权供应商/Authorized Supplier":""%>
                                    </td>
                                    <td>
                                        <%# Eval("AMOUNT")!=DBNull.Value?Convert.ToDouble(Eval("AMOUNT")).ToString("f2"):"0.00"%>
                                        <%--<%#Convert.ToDouble(Eval("AMOUNT")).ToString("f2") %>--%>
