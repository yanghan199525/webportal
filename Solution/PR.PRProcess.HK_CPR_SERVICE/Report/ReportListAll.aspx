<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportListAll.aspx.cs" Inherits="PR.PRProcess.HK_CPR_SERVICE.ReportListAll" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    香港单外采购审批（食品）报表/Out Of Catalogue Purchase Requisition Request(Services)Report</span>
            ...
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    香港单外审批生成失败记录(食品)/HK CPR Generate Failed Record(Services)</span>
            </div>
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    <thead>
