<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm.aspx.cs" Inherits="PR.PRProcess.HK_CPR_SERVICE.PrintForm" %>
...
<body>
    ...
    <div id="divmain">
            ...
            <div class="panel  hidden"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.HK_CPR_SERVICE") %></div>
            <table border="1" style="width: 100%; border-collapse: collapse;">
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYPURPOSE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_APPLYPURPOSE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERTYPE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SUPPLIERTYPE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITECODE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SITECODE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITENAME") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SITENAME"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.DELIVERYDATE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_DELIVERYDATE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERCODE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SUPPLIERCODE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERNAME") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SUPPLIERNAME"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ASSETTYPE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_ASSETTYPE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.AMOUNT") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_AMOUNT"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPREMARK") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_APPREMARK"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CPRFAMILYCODE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_CPRFAMILYCODE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.USER_SignedApproverName") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_USER_SIGNEDAPPROVERNAME"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.USER_SignedApproverName2") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_USER_SIGNEDAPPROVERNAME2"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.USER_SignedApproverName3") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_USER_SIGNEDAPPROVERNAME3"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SIGNEDAPPROVERNUMBER") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SIGNEDAPPROVERNUMBER"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPROVE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_APPROVE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FIXEDASSETS") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_FIXEDASSETS"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"></td>
                        <td class="tdtxt"></td>
                    </tr>
            </table>
            <div class="panel  "><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.HK_CPR_SERVICE_Items") %></div>
            <table border="1" style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="" class=" thlbl td_APPLYREASON"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYREASON") %></td>
                <td style="" class="hidden thlbl td_FAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYCODE") %></td>
                <td style="" class="hidden thlbl td_FAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYNAME") %></td>
                <td style="" class="hidden thlbl td_SUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYCODE") %></td>
                <td style="" class="hidden thlbl td_SUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYNAME") %></td>
                <td style="" class="hidden thlbl td_SUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYCODE") %></td>
                <td style="" class=" thlbl td_SUBSUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYNAME") %></td>
                <td style="" class=" thlbl td_ARTICLENAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLENAME") %></td>
                <td style="" class="hidden thlbl td_ARTICLECODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLECODE") %></td>
                <td style="" class=" thlbl td_ORDERUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNIT") %></td>
                <td style="" class="hidden thlbl td_UNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNIT") %></td>
                <td style="" class="hidden thlbl td_CONSUMPTIONUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNIT") %></td>
                <td style="" class="hidden thlbl td_CONVERSION"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONVERSION") %></td>
                <td style="" class="hidden thlbl td_STOCK"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.STOCK") %></td>
                <td style="" class="hidden thlbl td_NETVOMULE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULE") %></td>
                <td style="" class="hidden thlbl td_GROSSWEIGHT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHT") %></td>
                <td style="" class="hidden thlbl td_NETVOMULEUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULEUNIT") %></td>
                <td style="" class="hidden thlbl td_GROSSWEIGHTUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHTUNIT") %></td>
                <td style="" class=" thlbl td_SITEPRICE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITEPRICE") %></td>
                <td style="" class=" thlbl td_ORDERQUANTITY"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERQUANTITY") %></td>
                <td style="" class="hidden thlbl td_ORDERUNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNITVALUE") %></td>
                <td style="" class=" thlbl td_UNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNITVALUE") %></td>
                <td style="" class="hidden thlbl td_CONSUMPTIONUNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNITVALUE") %></td>
                <td style="" class=" thlbl td_SUBTOTALAMOUNT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBTOTALAMOUNT") %></td>
                <td style="" class="hidden thlbl td_NETNETPRICE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETNETPRICE") %></td>
            </tr>
