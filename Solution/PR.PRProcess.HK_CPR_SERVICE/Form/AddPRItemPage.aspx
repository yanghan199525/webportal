<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPRItemPage.aspx.cs" Inherits="PR.PRProcess.HK_CPR_SERVICE.AddPRItemPage" %>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE_Items") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYREASON") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <ult:dropdownlist id="ddlApplyReason" title="" onblur="checkExpression(this)" data-field="SUPPLIERTYPE" variable="SUPPLIERTYPE" cssclass="form-control  selector validate[required]" source="DataSource.SODEXO_香港申请理由" filter="" controlvalue="" runat="server">
                                        </ult:dropdownlist>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERCODE") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_HISTORYARTICLELIST" style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLENAME") %>:--%>
                                    <%=Lang.Get("PPR.PRProcess.HK_CPR_SERVICE.HISTORYARTICLELIST") %>:
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.OTHERARTICLENAME") %>:--%>
                                    <%--其他物品名称:--%>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLENAME") %>:
                                </div>
                                <div class="form-field">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNITINFORMATION") %>
                                <%--单位--%>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONVERSION") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <ult:textbox id="fld_CONVERSION" data-type='string' title="" onblur="checkExpression(this)" data-field="CONVERSION" variable="" controlvalue="" cssclass="form-control validate[required,custom[number],positivenumber,funcCall[checkPositiveInteger4]] " runat="server" data-errormessage-type-mismatch="订购与库存单位转换率必须大于0<br />The order to stock unit conversion rate must be greater than 0">
                                        </ult:textbox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULE") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    ...
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULEUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_GROSSWEIGHT" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHTUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-title">
                                <div class="fa-title">
                                    <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERINGINFORMATION") %>
                                    <%--采购信息--%>
                                </div>
                            ...
                            <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITEPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_NETNETPRICE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETNETPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERQUANTITY") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
    ...
    <script type='text/javascript' src='AddPRItemPage_.js?t=7a9a1d87-03c3-4f71-887c-881c71413689'></script>
