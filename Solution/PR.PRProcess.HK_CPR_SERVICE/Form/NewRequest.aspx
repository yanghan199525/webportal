<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="PR.PRProcess.HK_CPR_SERVICE.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_HK_CPR_SERVICE_Items = Page.FindControl("fld_detail_PROC_HK_CPR_SERVICE_Items") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_HK_CPR_SERVICE_Items.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_HK_CPR_SERVICE_Items = Page.FindControl("fld_detail_PROC_HK_CPR_SERVICE_Items") as Ultimus.UWF.Form.WebControls.Repeater;
            if (fld_detail_PROC_HK_CPR_SERVICE_Items.Items.Count == 0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_HK_CPR_SERVICE_Items, 1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="HK_CPR_SERVICE" processprefix="HK_CPR" tablename="PROC_HK_CPR_SERVICE"
            tablenamedetail="PROC_HK_CPR_SERVICE_ITEMS" runat="server"></ui:userinfo>
        <!--End main table-->
        ...
        <!--1.对Table做循环，判断单行,多行-->
        <!--1.1单行-->
        <div class="row" id="div_panel_HK_CPR_SERVICE">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-title">
                        <div class="fa-title">
                            ...
                            <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.HK_CPR_SERVICE") %>
                        </div>
                    ...
                    <div class="panel-body form-table">
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYPURPOSE") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <ult:DropDownList ID="fld_APPLYPURPOSE" title="" onblur="checkExpression(this)" data-field="APPLYPURPOSE" Variable="" CssClass="form-control  selector validate[required]" Source="DataSource.SODEXO_香港申请目的" Filter="" ControlValue="" runat="server" onchange="changeApplyPurpose()">
                                    </ult:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERTYPE") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPLYPURPOSETXT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYPURPOSETXT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_SUPPLIERTYPETXT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERTYPETXT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ASSETTYPETXT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ASSETTYPETXT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITECODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITENAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DELIVERYDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.DELIVERYDATE") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERNAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUPPLIERNAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ASSETTYPE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ASSETTYPE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.AMOUNT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPREMARK") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPROVEDATE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_CPRFAMILYCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CPRFAMILYCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_PURCHASINGAGENT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.PURCHASINGAGENT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_SIGNEDAPPROVERNUMBER" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SIGNEDAPPROVERNUMBER") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_DELIVERY" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.DELIVERY") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPROVE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_USER_SignedApproverName" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.USER_SignedApproverName") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_USER_SignedApprover2Name" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.USER_SignedApprover2Name") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_USER_SignedApprover3Name" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.USER_SignedApprover3Name") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_FIXEDASSETS" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FIXEDASSETS") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height: ">
                         ...
                         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISEDU" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ISEDU") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
        ...
        <!--1.2多行-->
        <!--Start Item table-->
        <div class="row" id="div_panel_HK_CPR_SERVICE_Items">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.HK_CPR_SERVICE_Items") %></div>
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_HK_CPR_SERVICE_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                                        <input id="tb_HK_CPR_SERVICE_ITEMS_rowCount" type="text" runat="server" />
                                    </td>
                                    <td class="th_no" style="width: 50px">
                                        <%=Lang.Get("No") %>
                                    </td>
                                    <td style="" class=" td_APPLYREASON"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYREASON") %><span style='color: red'>*</span></td>
                                    <td style="" class="hidden td_FAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYCODE") %></td>
                                    <td style="" class="hidden td_FAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYNAME") %></td>
                                    <td style="" class="hidden td_SUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYCODE") %></td>
                                    <td style="" class="hidden td_SUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYNAME") %></td>
                                    <td style="" class="hidden td_SUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYCODE") %></td>
                                    <td style="" class=" td_SUBSUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYNAME") %></td>
                                    <td style="" class=" td_ARTICLENAME"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLENAME") %></td>
                                    <td style="" class="hidden td_ARTICLECODE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLECODE") %></td>
                                    <td style="" class=" td_ORDERUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNIT") %></td>
                                    <td style="" class="hidden td_UNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNIT") %></td>
                                    <td style="" class="hidden td_CONSUMPTIONUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNIT") %></td>
                                    <td style="" class="hidden td_CONVERSION"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONVERSION") %></td>
                                    <td style="" class="hidden td_STOCK"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.STOCK") %></td>
                                    <td style="" class="hidden td_NETVOMULE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULE") %></td>
                                    <td style="" class="hidden td_GROSSWEIGHT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHT") %></td>
                                    <td style="" class="hidden td_NETVOMULEUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULEUNIT") %></td>
                                    <td style="" class="hidden td_GROSSWEIGHTUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHTUNIT") %></td>
                                    <td style="" class=" td_SITEPRICE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITEPRICE") %><span style='color: red'>*</span></td>
                                    <td style="" class=" td_ORDERQUANTITY"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERQUANTITY") %></td>
                                    <td style="" class="hidden td_ORDERUNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNITVALUE") %></td>
                                    <td style="" class="hidden td_UNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNITVALUE") %></td>
                                    <td style="" class="hidden td_CONSUMPTIONUNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNITVALUE") %></td>
                                    <td style="" class="hidden td_SUBTOTALAMOUNT"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBTOTALAMOUNT") %></td>
                                     <td style="" class="hidden td_SUBSUBFAMILYCE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYCE") %></td>
                                    <td style="" class="hidden td_NETNETPRICE"><%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETNETPRICE") %></td>
                                    <td style="width: 60px"><%=Lang.Get("Action") %></td>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_HK_CPR_SERVICE_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td class=" td_APPLYREASON" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.APPLYREASON").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_FAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_FAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.FAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBFAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBFAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBSUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SUBSUBFAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ARTICLENAME" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLENAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_ARTICLECODE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ARTICLECODE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ORDERUNIT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_UNIT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_CONSUMPTIONUNIT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_CONVERSION" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONVERSION").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_STOCK" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.STOCK").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_NETVOMULE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_GROSSWEIGHT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_NETVOMULEUNIT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETVOMULEUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_GROSSWEIGHTUNIT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.GROSSWEIGHTUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SITEPRICE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SITEPRICE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ORDERQUANTITY" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERQUANTITY").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_ORDERUNITVALUE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.ORDERUNITVALUE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_UNITVALUE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.UNITVALUE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_CONSUMPTIONUNITVALUE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.CONSUMPTIONUNITVALUE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBTOTALAMOUNT" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBTOTALAMOUNT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBSUBFAMILYCE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.SUBSUBFAMILYCE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_NETNETPRICE" data-label='<%=Lang.Get("PR.PRProcess.HK_CPR_SERVICE.NETNETPRICE").Split('<')[0] %>'>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteCPRRow('tb_HK_CPR_SERVICE_ITEMS',this);}return false;"
                        ...
                        <button id="btnAddCPRItems" onclick="addPRItemsRow('tb_HK_CPR_SERVICE_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=7a9a1d87-03c3-4f71-887c-881c714139fg'></script>
