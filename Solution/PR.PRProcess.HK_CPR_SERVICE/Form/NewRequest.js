...
function beforeSubmit() {
    ...
    var tabCtl = document.getElementById("tb_HK_CPR_SERVICE_ITEMS");
    ...
    if (tabCtl.rows.length == 2 && $(existrow).find("input[id*='fld_APPLYREASON']").val() == "") {
        ...
        if (time.getHours() < 24 && time.getHours() >= 10) {
            if (Language == 'en-US') {
                alert("Due to system adjustment, please submit CPR before 10 am! Please contact Supply Mamngement for any problems.");
            } else {
