<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="PR.PRProcess.CPR_NONFOOD.ReportList" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    单外采购审批（非食品）报表/Out Of Catalogue Purchase Requisition Request(Non-Food)Report</span>
                            ...
                            <itemtemplate>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%#Eval("PROCESSNAME").ToString()=="CPR_NONFOOD"?"食品":Eval("PROCESSNAME").ToString()=="CPR_NONFOOD"?"非食品":"服务"%>
                                    </td>
                                    <td>
                                        <%#Eval("SUPPLIERCODE")%>
                                    </td>
