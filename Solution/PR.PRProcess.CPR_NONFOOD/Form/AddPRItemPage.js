...
$(function () {
    ...
    if ($("#hdSupplierCode").val() != "") {
        ...
        ddlSupplier.empty();
        ddlSupplier.selectpicker('val', $('#hdSupplierName').val());
        ddlSupplier.append("<option value=''selected>" + $('#hdSupplierName').val() + "</option>");
        ddlSupplier.selectpicker('refresh');
        ddlSupplier.find("option:selected").val($('#hdSupplierName').val())
