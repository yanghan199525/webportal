<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="PR.PRProcess.CPR_NONFOOD.Approval" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="CPR_NONFOOD" processpefix="CPRN" tablename="PROC_CPR_NONFOOD"
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SignedApprover" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SignedApprover") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SignedApprover2" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SignedApprover2") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SignedApprover3" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SignedApprover3") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPREMARK") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                ...
                                <ult:Repeater ID="fld_detail_PROC_CPR_NONFOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <button onclick="editCPRRow('tb_CPR_NONFOOD_ITEMS',<%#Eval("FAMILYCODE")%>)" type="button"
    ...
    <script type='text/javascript' src='Approval.js?t=2b0649da-5997-40f6-a996-284d969cf768'></script>
