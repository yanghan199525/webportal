<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPRItemPage.aspx.cs" Inherits="PR.PRProcess.CPR_NONFOOD.AddPRItemPage" %>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CPR_NONFOOD_Items") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.APPLYREASON") %>:
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.SUPPLIERCODE") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_HISTORYARTICLELIST" style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.ARTICLENAME") %>:--%>
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.HISTORYARTICLELIST") %>:
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.UNITINFORMATION") %>
                                <%--单位--%>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.ORDERUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETVOMULEUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-title">
                                <div class="fa-title">
                                    <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                    <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ORDERINGINFORMATION") %>
                                    <%--采购信息--%>
                                </div>
                            ...
                            <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITEPRICE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.SITEPRICE") %>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
    ...
    <script type="text/javascript" src='AddPRItemPage.js?t=dc64a1ef-95e5-4fb4-a793-a14f354d35wed'></script>
