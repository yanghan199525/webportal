<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="PR.PRProcess.CPR_NONFOOD.NewRequest" %>
   ...
   <style>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_CPR_NONFOOD_Items = Page.FindControl("fld_detail_PROC_CPR_NONFOOD_Items") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_CPR_NONFOOD_Items.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_CPR_NONFOOD_Items = Page.FindControl("fld_detail_PROC_CPR_NONFOOD_Items") as Ultimus.UWF.Form.WebControls.Repeater;
            if (fld_detail_PROC_CPR_NONFOOD_Items.Items.Count == 0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_CPR_NONFOOD_Items, 1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="CPR_NONFOOD" processprefix="CPRN" tablename="PROC_CPR_NONFOOD"
            tablenamedetail="PROC_CPR_NONFOOD_ITEMS" runat="server"></ui:userinfo>
        <!--End main table-->
        ...
        <!--1.对Table做循环，判断单行,多行-->
        <!--1.1单行-->
        <div class="row" id="div_panel_CPR_NONFOOD">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-title">
                        <div class="fa-title">
                            ...
                            <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CPR_NONFOOD") %>
                        </div>
                    ...
                    <div class="panel-body form-table">
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPLYPURPOSE") %><span style='color: red'>*</span>:
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUPPLIERTYPE") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SITECODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SITENAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DELIVERYDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.DELIVERYDATE") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <%--past[2012/12/20]
                        ...
                        <%--原始 End--%>
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ONLINEORSUPERMARKET">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ONLINEORSUPERMARKET") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUPPLIERCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERNAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUPPLIERNAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="hidden col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_FIXEDASSETS" style="height: 55px">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.FIXEDASSETS") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_USER_SignedApproverName" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SignedApproverName") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_USER_SignedApprover2Name" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SignedApprover2Name") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_USER_SignedApprover3Name" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SignedApprover3Name") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                                        ...
                                        <span class="add-on input-group-addon" style="cursor: pointer;" onclick="clearSignedApprover()3"><i class="fa fa-trash"></i></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <%--<div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden-sm hidden-xs" style="height:54px; ">
                            <div class="form-label">
                            </div>
                            <div class="form-field">
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.AMOUNT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="hidden col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SHOWREMARK" style="height: 55px">
                            <div class="form-label">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height: 55px">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPREMARK") %> <span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="hidden col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_IsPrePaid" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.IsPrePaid") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ASSETTYPE" style="height: 54px;">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ASSETTYPE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPROVEDATE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_PCCOMPCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.PCCOMPCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPLYPURPOSETXT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPLYPURPOSETXT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_SUPPLIERTYPETXT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUPPLIERTYPETXT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ASSETTYPETXT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ASSETTYPETXT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_CPRFAMILYCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CPRFAMILYCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_SIGNEDAPPROVERNUMBER" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SIGNEDAPPROVERNUMBER") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_PURCHASINGAGENT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.PURCHASINGAGENT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_DELIVERY" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.DELIVERY") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPROVE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_USER_SEGMENTDIRECTOR_1" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.USER_SEGMENTDIRECTOR_1") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_SEGMENTDIRECTOR" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SEGMENTDIRECTOR") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCOR" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ISCOR") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCORName" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ISCORName") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISHISTORY" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ISHISTORY") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
        ...
        <!--1.2多行-->
        <!--Start Item table-->
        <div class="row" id="div_panel_CPR_NONFOOD_Items">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CPR_NONFOOD_Items") %></div>
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_CPR_NONFOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                                        <input id="tb_CPR_NONFOOD_ITEMS_rowCount" type="text" runat="server" />
                                    </td>
                                    <td class="th_ch" style="width: 50px">勾选</td>
                                    <td class="th_no" style="width: 50px">
                                        <%=Lang.Get("No") %>
                                    </td>
                                    <td style="" class=" td_APPLYREASON"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPLYREASON") %><span style='color: red'>*</span></td>
                                    <td style="" class=" td_SUBSUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBSUBFAMILYNAME") %></td>
                                    <td style="" class=" td_ARTICLENAME"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ARTICLENAME") %></td>
                                    <td style="" class=" td_ORDERUNIT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ORDERUNIT") %></td>
                                    <td style="" class=" td_SITEPRICE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SITEPRICE") %><span style='color: red'>*</span></td>
                                    <td style="" class=" td_ORDERQUANTITY"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ORDERQUANTITY") %><span style='color: red'>*</span></td>
                                    ...
                                    <td style="" class="hidden td_FAMILYCODE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.FAMILYCODE") %></td>
                                    <td style="" class="hidden td_FAMILYNAME"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.FAMILYNAME") %></td>
                                    <td style="" class="hidden td_SUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBFAMILYCODE") %></td>
                                    <td style="" class="hidden td_SUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBFAMILYNAME") %></td>
                                    <td style="" class="hidden td_SUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBSUBFAMILYCODE") %></td>
                                    <td style="" class="hidden td_ARTICLECODE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ARTICLECODE") %></td>
                                    <td style="" class="hidden td_UNIT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.UNIT") %></td>
                                    <td style="" class="hidden td_CONSUMPTIONUNIT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CONSUMPTIONUNIT") %></td>
                                    <td style="" class="hidden td_CONVERSION"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CONVERSION") %></td>
                                    <td style="" class="hidden td_STOCK"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.STOCK") %></td>
                                    <td style="" class="hidden td_NETVOMULE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETVOMULE") %></td>
                                    <td style="" class="hidden td_GROSSWEIGHT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.GROSSWEIGHT") %></td>
                                    <td style="" class="hidden td_NETVOMULEUNIT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETVOMULEUNIT") %></td>
                                    <td style="" class="hidden td_GROSSWEIGHTUNIT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.GROSSWEIGHTUNIT") %></td>
                                    <td style="" class="hidden InvoiceType"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.InvoiceType") %></td>
                                    <td style="" class="hidden td_TAXCODE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.TAXCODE") %></td>
                                    <td style="" class="hidden td_TAXRATE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.TAXRATE") %></td>
                                    <td style="" class="hidden InitOrderLimt"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.InitOrderLimt") %></td>
                                    <td style="" class="hidden td_ORDERUNITVALUE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ORDERUNITVALUE") %></td>
                                    <td style="" class="hidden td_UNITVALUE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.UNITVALUE") %></td>
                                    <td style="" class="hidden td_CONSUMPTIONUNITVALUE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CONSUMPTIONUNITVALUE") %></td>
                                    <td style="" class="hidden td_SUBTOTALAMOUNT"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBTOTALAMOUNT") %></td>
                                    <td style="" class="hidden td_SUBSUBFAMILYCE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBSUBFAMILYCE") %></td>
                                    <td style="" class="hidden td_NETNETPRICE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETNETPRICE") %></td>
                                    <td style="" class="hidden td_NETNETPRICE"><%=Lang.Get("PR.PRProcess.CPR_FOOD.NETNETPRICE") %></td>
                                    <td style="" class="hidden td_OLDSUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.OLDSUBSUBFAMILYCODE") %></td>
                                    <td style="" class="hidden td_ARTICLEID"><%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ARTICLEID") %></td>
                                    <td style="width: 60px"><%=Lang.Get("Action") %></td>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_CPR_NONFOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td class=" td_APPLYREASON" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.APPLYREASON").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SUBSUBFAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBSUBFAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ARTICLENAME" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ARTICLENAME").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ORDERUNIT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ORDERUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_FAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.FAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_FAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.FAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBFAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBFAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBSUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBSUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_ARTICLECODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ARTICLECODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_UNIT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.UNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_CONSUMPTIONUNIT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CONSUMPTIONUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_CONVERSION" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CONVERSION").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_STOCK" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.STOCK").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_NETVOMULE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETVOMULE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_GROSSWEIGHT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.GROSSWEIGHT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_NETVOMULEUNIT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETVOMULEUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_GROSSWEIGHTUNIT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.GROSSWEIGHTUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden InvoiceType" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.InvoiceType").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_TAXCODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.TAXCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden InitOrderLimt" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.InitOrderLimt").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_TAXRATE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.TAXRATE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_ORDERUNITVALUE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ORDERUNITVALUE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_UNITVALUE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.UNITVALUE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_CONSUMPTIONUNITVALUE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.CONSUMPTIONUNITVALUE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBTOTALAMOUNT" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBTOTALAMOUNT").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBSUBFAMILYCE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.SUBSUBFAMILYCE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_NETNETPRICE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETNETPRICE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_OLDSUBSUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.OLDSUBSUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_ARTICLEID" data-label='<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.ARTICLEID").Split('<')[0] %>'>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteCPRRow('tb_CPR_NONFOOD_ITEMS',this);}return false;"
                        ...
                        <button id="btnAddCPRItems" onclick="addPRItemsRow('tb_CPR_NONFOOD_ITEMS');return false;"
