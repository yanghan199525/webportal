<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NodalPersonManagement.aspx.cs" Inherits="Ultimus.UWF.CPR.NodalPersonManagement" %>
...
<head runat="server">
    ...
    <title>BPM-Node Responsible Person Maintenance</title>
            ...
            <div class="page-header">
                ...
                <div class="right">
                    <div class="btn-group" role="group" aria-label="...">
                        <a href="NodalPersonDetails.aspx?Type=Add" class="btn btn-default" target="_blank"><i class="fa fa-plus"></i></a>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12 padding-b-5">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-7">
                                            <ult:TextBox ID="txt_leaderName" runat="server" CssClass="form-control" Destination="leaderName"></ult:TextBox>
                                        </div>
                                        <div class="col-md-1"></div>
                                    </div>
                                </div>
                                ...
                                <table id="tasklist" class="table table-hover table-nofooter" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <td style="width: 15%;">节点名称</td>
                                            <td style="width: 15%;">节点负责人编号</td>
                                            <td style="width: 15%;">节点负责人名称</td>
                                    ...
                                    <tbody class="cursor-pointer" id="taskRows">
                                        <ult:Repeater ID="rptList" runat="server" Source="BizDB.SODEXO_PROCESSSTEPAPPROVER" PagerID="AspNetPager1">
                                            <ItemTemplate>
                                                <tr>
                                                    <td>
                                                        <%#Eval("Id")%>
                                                    ...
                                                    <td>
                                                        <%--<%# JudgmentHandler(Eval("Id").ToString()) %>--%>
                                                        <a class="btn btn-icon btn-sm btn-warning" target="_blank" href="NodalPersonDetails.aspx?Type=Edit&NodalPersonID=<%#Eval("Id")%>">编辑</a>
