...
namespace UWF.Process.CPR_ALL
{
    ...
    rpt.Source = "BizDB.select * from PROC_CPR_TAKUMI where 1=1 "+process.GetReportViewSql    ("CPR_ALL",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("CPR_ALL");
    ExcelUtil.Export(dt);
    }
