...
namespace PR.PRProcess.CPR_SERVICE
{
    public partial class AddPRItemPage : System.Web.UI.Page
    {
        ...
        public static string BindOrderUnit()
        {
            ...
            StringBuilder sSql = new StringBuilder();
            sSql.AppendFormat(@"SELECT [OrderUnitAbbr],[OrderUnit{0}] FROM [dbo].[SODEXO_OrderUnit]", language);
        ...
        public static string BindBaseUnit()
        {
            ...
            StringBuilder sSql = new StringBuilder();
            sSql.AppendFormat(@"SELECT [BaseUnitAbbr],[BaseUnit{0}] FROM [dbo].[SODEXO_BaseUnit]", language);
            DataTable dt = DataAccess.Instance("BizDB").ExecuteDataTable(sSql.ToString());
            return new JsonHelper().DataTableToJson(dt);
        }
        ...
        public static string BindFamily(string categorycode)
        {
            ...
            StringBuilder sSql = new StringBuilder();
            sSql.AppendFormat(@"SELECT [FamilyCode],[FamilyName{0}] FROM [dbo].[SODEXO_t_Foun_SCM_FamilyHierarchy]", language);
            ...
            sSql.AppendFormat(@" group by [FamilyCode],[FamilyName{0}] order by FamilyCode", language);
            DataTable dt = DataAccess.Instance("BizDB").ExecuteDataTable(sSql.ToString());
            return new JsonHelper().DataTableToJson(dt);
        }
        ...
        public static string BindSubFamily(string categorycode, string familycode)
        {
            ...
            StringBuilder sSql = new StringBuilder();
            sSql.AppendFormat(@"SELECT [SubFamilyName{0}],[SubFamilyCode] FROM [dbo].[SODEXO_t_Foun_SCM_FamilyHierarchy]", language);
            if (categorycode == "Food")
            {
                sSql.Append(@" where CategoryNameEN='Food'");
            }
            ...
            sSql.AppendFormat(@" AND FamilyCode='{0}' group by [SubFamilyName{1}],[SubFamilyCode] order by SubFamilyCode", familycode, language);
            DataTable dt = DataAccess.Instance("BizDB").ExecuteDataTable(sSql.ToString());
            return new JsonHelper().DataTableToJson(dt);
        }
        ...
        public static string BindSubSubFamily(string categorycode, string familycode, string subfamilycode)
        {
            ...
            StringBuilder sSql = new StringBuilder();
            sSql.AppendFormat(@"SELECT [SubSubFamilyName{0}],[SubSubFamilyCode] FROM [dbo].[SODEXO_t_Foun_SCM_FamilyHierarchy]", language);
            if (categorycode == "Food")
            {
                sSql.Append(@" where CategoryNameEN='Food'");
            }
            ...
            sSql.AppendFormat(@" AND FamilyCode='{0}' AND SubFamilyCode='{1}' group by [SubSubFamilyName{2}],[SubSubFamilyCode] order by SubSubFamilyCode", familycode, subfamilycode, language);
            DataTable dt = DataAccess.Instance("BizDB").ExecuteDataTable(sSql.ToString());
            return new JsonHelper().DataTableToJson(dt);
        }

        [WebMethod]
        public static string BindArticle(string sitecode, string articlefamily, string suppliertype, string suppliercode, string category, string familycode, string searchcondition)
        {
            StringBuilder sSql = new StringBuilder();
            ...
            if (suppliertype == "9")
            {
                ...
                if (suppliercode == "")
                {
                    ...
                    {
                        sSql.AppendFormat(@"SELECT TOP 30 [ArticleCode],REPLACE(ArticleName, CHAR(10), '') AS [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes],[SupplierCode],[SitePrice],[NetNetPrice] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a,[dbo].SODEXO_t_Foun_SCM_FamilyHierarchy fh where ou.OrderUnitAbbr=a.UOM_PurUnit AND a.ArticleFamily=fh.SubSubFamilyCode AND [SiteCode]='{0}' AND EffictiveEndDate>='{1}' and fh.CategoryNameEN='{2}' ORDER BY [ArticleName]", sitecode, DateNow, category);
                    }
                    else
                    {
                        sSql.AppendFormat(@"SELECT TOP 30 [ArticleCode],REPLACE(ArticleName, CHAR(10), '') AS [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes],[SupplierCode],[SitePrice],[NetNetPrice] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a,[dbo].SODEXO_t_Foun_SCM_FamilyHierarchy fh where ou.OrderUnitAbbr=a.UOM_PurUnit AND a.ArticleFamily=fh.SubSubFamilyCode AND [SiteCode]='{0}' AND EffictiveEndDate>='{1}' and fh.CategoryNameEN='{2}' AND ArticleName LIKE N'%{3}%' ORDER BY [ArticleName]", sitecode, DateNow, category, searchcondition);
                    }
                ...
                else
                {
                    if (string.IsNullOrEmpty(searchcondition.Trim()) || searchcondition.Trim() == "")
                    {
                        sSql.AppendFormat(@"SELECT TOP 30 [ArticleCode],REPLACE(ArticleName, CHAR(10), '') AS [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes],[SupplierCode],[SitePrice],[NetNetPrice] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a,[dbo].SODEXO_t_Foun_SCM_FamilyHierarchy fh where ou.OrderUnitAbbr=a.UOM_PurUnit AND a.ArticleFamily=fh.SubSubFamilyCode AND [SiteCode]='{0}' AND EffictiveEndDate>='{1}' and fh.CategoryNameEN='{2}' AND SupplierCode='{3}' AND fh.FamilyCode='{4}'  ORDER BY [ArticleName]", sitecode, DateNow, category, suppliercode, familycode);
                    }
                    else
                    {
                        sSql.AppendFormat(@"SELECT TOP 30 [ArticleCode],REPLACE(ArticleName, CHAR(10), '') AS [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes],[SupplierCode],[SitePrice],[NetNetPrice] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a,[dbo].SODEXO_t_Foun_SCM_FamilyHierarchy fh where ou.OrderUnitAbbr=a.UOM_PurUnit AND a.ArticleFamily=fh.SubSubFamilyCode AND [SiteCode]='{0}' AND EffictiveEndDate>='{1}' and fh.CategoryNameEN='{2}' AND SupplierCode='{3}' AND fh.FamilyCode='{4}' AND ArticleName LIKE N'%{5}%' ORDER BY [ArticleName]", sitecode, DateNow, category, suppliercode, familycode, searchcondition);
                    }
                ...
                if (dt.Rows.Count == 0)
                {
                    ...
                    if (MasterPC != "false")
                    {
                        ...
                        else
                        {
                            if (string.IsNullOrEmpty(searchcondition.Trim()) || searchcondition.Trim() == "")
                            {
                                sSql.AppendFormat(@"SELECT TOP 30 [ArticleCode],REPLACE(ArticleName, CHAR(10), '') AS [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes],[SupplierCode],[SitePrice],[NetNetPrice] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a,[dbo].SODEXO_t_Foun_SCM_FamilyHierarchy fh where ou.OrderUnitAbbr=a.UOM_PurUnit AND a.ArticleFamily=fh.SubSubFamilyCode AND [SiteCode]='{0}' AND EffictiveEndDate>='{1}' and fh.CategoryNameEN='{2}' AND SupplierCode='{3}' AND fh.FamilyCode='{4}' AND ((IsOneTimeUsing=1 AND UseTimes=0) OR IsOneTimeUsing=0) ORDER BY [ArticleName]", MasterPC, DateNow, category, suppliercode, familycode);
                            }
                            else
                            {
                                sSql.AppendFormat(@"SELECT TOP 30 [ArticleCode],REPLACE(ArticleName, CHAR(10), '') AS [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes],[SupplierCode],[SitePrice],[NetNetPrice] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a,[dbo].SODEXO_t_Foun_SCM_FamilyHierarchy fh where ou.OrderUnitAbbr=a.UOM_PurUnit AND a.ArticleFamily=fh.SubSubFamilyCode AND [SiteCode]='{0}' AND EffictiveEndDate>='{1}' and fh.CategoryNameEN='{2}' AND SupplierCode='{3}' AND fh.FamilyCode='{4}' AND ArticleName LIKE N'%{5}%' AND ((IsOneTimeUsing=1 AND UseTimes=0) OR IsOneTimeUsing=0) ORDER BY [ArticleName]", MasterPC, DateNow, category, suppliercode, familycode, searchcondition);
                            }
        ...
        #region MyRegion
        //public static string BindArticle(string sitecode, string articlefamily, string suppliertype, string suppliercode)
        //{
        //    StringBuilder sSql = new StringBuilder();
        //    string DateNow = DateTime.Now.ToString("yyyy-MM-dd");
        //    if (suppliertype == "9")
        //    {
        //        sSql.Length = 0;
        //        sSql.AppendFormat(@"SELECT [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes] FROM [dbo].[SODEXO_OrderUnit] ou,[dbo].[SODEXO_Article] a where ou.OrderUnitAbbr=a.UOM_PurUnit AND [SiteCode]='{0}' AND [ArticleFamily]='{1}' AND SupplierCode='{2}' AND EffictiveEndDate>='{3}' ORDER BY [ArticleName]", sitecode, articlefamily, suppliercode, DateNow);
        //    }
        //    else
        //    {
        //        sSql.Length = 0;
        //        sSql.AppendFormat(@"SELECT [ArticleName],[ArticleFamily],[UOM_PurUnit],[UOM_Pur2InvRate],[UOM_InvUnit],[UOM_Inv2UseRate],[UOM_UseUnit],[Gross_weight],[NetVolume],[NetVolumeUnit],[IsOneTimeUsing],[UseTimes] FROM [dbo].[SODEXO_Article] WHERE [SiteCode]='{0}' AND [ArticleFamily]='{1}' ORDER BY [ArticleName]", sitecode, articlefamily);
        //    }
        //    DataTable dt = DataAccess.Instance("BizDB").ExecuteDataTable(sSql.ToString());
        //    return new JsonHelper().DataTableToJson(dt);
        //}
        ...
        public static string BindSupplier(string suppliertype, string searchcondition, string pccode, string subfamilycode)
        {
            ...
            else if (suppliertype == "9")
            {
                ...
                if (string.IsNullOrEmpty(searchcondition.Trim()) || searchcondition.Trim() == "")
                {
                    url.AppendFormat("{2}?pcCode={0}&subSubFamilyCode={1}&supplierCodeOrName=null", pccode, subfamilycode, urls);
                }
                else
                {
