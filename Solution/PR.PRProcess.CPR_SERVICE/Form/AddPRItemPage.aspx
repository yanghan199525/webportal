<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPRItemPage.aspx.cs" Inherits="PR.PRProcess.CPR_SERVICE.AddPRItemPage" %>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.CPR_SERVICE_Items") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.FAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <select id="ddlFamily" class="selectpicker form-control" data-live-search="true">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.SUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <select id="ddlSubFamily" class="selectpicker form-control" data-live-search="true">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.SUBSUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">

                                        <select id="ddlSubSubFamily" class="selectpicker form-control" data-live-search="true">
                                        </select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                ...
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <select id="ddlSupplier" class="selectpicker form-control" data-live-search="true">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                ...
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <ult:textbox id="fld_SupplierCode" data-type='string' title="" onblur="checkExpression(this)" data-field="OTHERARTICLENAME" variable="" controlvalue="" cssclass="form-control ReadOnly validate[required]" runat="server">
                                    </ult:textbox>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_HISTORYARTICLELIST" style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.ARTICLENAME") %>:--%>
                                    <%=Lang.Get("PR.PRProcess.CPR_SERVICE.HISTORYARTICLELIST") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <%--<ult:textbox id="fld_SITENAME" data-type='string' title="" onblur="checkExpression(this)" data-field="ARTICLENAME" variable="" controlvalue="" cssclass="form-control   " runat="server">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    ...
                                    <%--其他物品名称:--%>
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.ARTICLENAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.UNITINFORMATION") %>
                                <%--单位--%>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ORDERUNIT" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.ORDERUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <select id="ddlOrderUnit" name="ddlOrderUnit" class="selectpicker form-control validate[required]" data-live-search="true">
                                        </select>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CONSUMPTIONUNIT" style="height: ">
                                <div class="form-label">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12 form-cell " id="div_field_STOCK" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.STOCK") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <ult:textbox id="fld_STOCK" data-type='string' title="" onblur="checkExpression(this)" data-field="STOCK" variable="" controlvalue="" cssclass="form-control  validate[required,custom[number],positivenumber,checkPositiveInteger4]" runat="server" data-errormessage-type-mismatch="库存与消耗单位转换率必须大于0<br />The stock to consumption conversion rate must be greater than 0">
                                    </ult:textbox>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.NETVOMULE") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.CPR_SERVICE.NETVOMULEUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <select id="ddlNetVomule" class="form-control  selector validate[required]">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_GROSSWEIGHT" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.GROSSWEIGHT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                                        <ult:textbox id="fld_GROSSWEIGHT" data-type='string' title="" onblur="checkExpression(this)" data-field="GROSSWEIGHT" variable="" controlvalue="" cssclass="form-control validate[required,custom[number]] " runat="server">
                                    </ult:textbox>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.GROSSWEIGHTUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-title">
                                <div class="fa-title">
                                    <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                    <%=Lang.Get("PR.PRProcess.CPR_SERVICE.ORDERINGINFORMATION") %>
                                    <%--采购信息--%>
                                </div>
                            ...
                            <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITEPRICE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.OutOfCataloguePurchaseRequisitionRequest.SITEPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                            <ult:textbox id="fld_SITEPRICE" title="" data-type='string' onblur="checkExpression(this)" data-field="SITEPRICE" cssclass="form-control positivenumber,funcCall[checkPositiveInteger2]] " controlvalue='<%#Eval("SITEPRICE")%>' runat="server" data-errormessage-type-mismatch="采购单价必须大于0<br />Purchase unit price must be greater than 0">
                                                    </ult:textbox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ORDERQUANTITY" style="height: ">
                                    <div class="form-label">
    ...
    <script type="text/javascript" src='AddPRItemPage.js?t=dc64a1ef-95e5-4fb4-a793-a544f354d90135'></script>
