    ...
    public partial class Approval : System.Web.UI.Page
    {
        ...
        public string getDeliveryDate(string ProcessName, string Incident, string TaskID)
        {
            ...
            try
            {
                ...
                {
                    DataTable PROC_CPR_FOOD = DataAccess.Instance("BizDB").ExecuteDataTable("SELECT * FROM PROC_CPR_SERVICE WHERE PROCESSNAME='" + ProcessName + "' AND INCIDENT=" + Incident);
        ...
        //        if (DataAccess.Instance("UltDB").ExecuteDataTable(sSql.ToString()).Rows.Count > 0)
        //        {
        //            DeliveryDate = DataAccess.Instance("BizDB").ExecuteScalar("SELECT DELIVERYDATE FROM PROC_CPR_SERVICE WHERE PROCESSNAME='" + ProcessName + "' AND INCIDENT=" + Incident).ToString();
        //        }
        //        return DeliveryDate;
        //    }
        //    catch (Exception ex)
