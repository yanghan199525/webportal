    ...
    public partial class NewRequest : System.Web.UI.Page
    {
        ...
        protected void AfterLoad()
        {
            ...
            if (procType.ToUpper().Trim() == "REPORT")
            {
                ...
                string url = string.Format("{4}/Solution/PR.PRProcess.CPR_SERVICE/Form/NewRequest.aspx?ProcessName=CPR_SERVICE&StepName=Begin&Incident={0}&TaskID={1}&UserName={2}&Type=MYREQUEST&ServerName=&t=&FORMID={3}&hasformid=0&t=&processStatus=1&ShowType=REPORT", Incident, TaskID, UserName, FORMID, rootPath);
