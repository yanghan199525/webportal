                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class=" td_SITEPRICE" data-label='<%=Lang.Get("PR.PRProcess.CPR_SERVICE.SITEPRICE").Split('<')[0] %>'>
                                                <ult:Label ID="fld_SITEPRICE" title="" data-type='string' onblur="checkExpression(this)" data-field="SITEPRICE" CssClass="item-control validate[custom[number]] ReadOnly autonumber" ControlValue='<%#Eval("SITEPRICE")%>' runat="server">
                                                </ult:Label>
                                            </td>
