                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ServiceEstimatedFinishTime" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.ServiceEstimatedFinishTime") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                    <div class="input-prepend input-group">
                        ...
                        <div class="hidden col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_IsPrePaid" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.IsPrePaid") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_INVOICEPATH" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.INVOICEPATH") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height: 50px">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.APPREMARK")  %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCOR" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.ISCOR") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCORName" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.ISCORName") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell  hidden" id="div_field_ISSALARY" style="height: ">
                            <div class="form-label" id="ISSALARY">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.ISSALARY")%>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <%-- <div class="col-lg-4 col-sm-6 col-xs-12 form-cell  hidden" id="div_field_ORIGINALAMOUNT" style="height: ">
                            <div class="form-label" id="ORIGINALAMOUNT">
                                <%=Lang.Get("PR.PRProcess.CPR_SERVICE.ORIGINALAMOUNT")%>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                                ...
                                <ult:Repeater ID="fld_detail_PROC_CPR_SERVICE_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteCPRRow('tb_CPR_SERVICE_ITEMS',this);}return false;"
                        ...
                        <button id="btnAddCPRItems" onclick="addPRItemsRow('tb_CPR_SERVICE_ITEMS');return false;"
