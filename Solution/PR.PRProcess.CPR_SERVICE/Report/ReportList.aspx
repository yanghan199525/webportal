<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="PR.PRProcess.CPR_SERVICE.ReportList" %>
...
<head>
    ...
    <title>CPR_SERVICE Report</title>
...
<body>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    单外采购审批（服务）报表/Out Of Catalogue Purchase Requisition Request(Service)Report</span>
    ...
    <script type='text/javascript' src='ReportList.js?t=637139211536462593'></script>
</body>
</html>
