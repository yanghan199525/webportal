...
namespace PR.PRProcess.CPR_SERVICE
{
    public partial class ReportList : System.Web.UI.Page
    {
        ...
        protected void lbExport_Click(object sender, EventArgs e)
        {
            ...
            dt=ExportLogic.GetSchemaTable("CPR_SERVICE", dt);
            ExcelUtil.Export(dt);
        }
        ...
        protected void Button1_BeforeClick(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            rpt.Source = string.Format(@"BizDB.select * from (SELECT T.*,WF.ACTION FROM (
		            ...
		            SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE FROM PROC_CPR_SERVICE where  INCIDENT!='-1' 
