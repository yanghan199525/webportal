...
<body>
    ...
    tablenamedetail="" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CataLogID" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_CATALOGID" data-type='string'  title="" onblur="checkExpression(this)" data-field="CATALOGID"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                    </ult:textbox>
    ...
    <script type='text/javascript' src='NewRequest.js?t=37fa5ca8-71b0-4eb9-9525-6a9d47cb5797'></script>
</body>
</html>
