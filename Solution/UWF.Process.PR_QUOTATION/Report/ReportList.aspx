<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="UWF.Process.PR_QUOTATION.ReportList" %>
...
<head>
    ...
    <title>PR_QUOTATION Report</title>
...
<body>
            ...
            <div class="app-page-title" style="height: 5rem; margin: 0; padding: 0;">
                <div class="page-title-wrapper pl-3 pr-3 mr-3" style="height: 4.5rem;">
                    <div class="page-title-heading">
                        ...
                        <div>
                            <div class="page-title-subheading"><h4>报价单审批 <%= Lang.Get("Report") %></h4></div>
                        </div>
                    </div>
                ...
                <div class="card-body pb-2">
                    ...
                    <div style="width: 100%; overflow-x: scroll;">
                        <table id="detailTable" class="table table-hover table-striped table-bordered mt-3">
                            ...
                            <tbody>
                                <ult:Repeater ID="rptList" OnItemCommand="rpSource_ItemCommand" Source="BizDB.PROC_PR_QUOTATION" PagerID="AspNetPager1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                          ...
                                          <%--  <td>
                                            ...
                                            <td>
                                                <a target="_blank" href="" onclick="javascript:objReport.openForm('<%#Eval(" FormID") %>','<%#Eval("ProcessName") %>','<%#Eval("Incident") %>');return false;" style="cursor:head">
                                                    <%#Eval("DOCUMENTNO")%>
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                <%# Eval("REQUESTDATE")!=DBNull.Value?String.Format("{0:yyyy-MM-dd}", MyLib.ConvertUtil.ToDateTime(Eval("REQUESTDATE"))):""%>
                                                    ...
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("CataLogID")%>'>
                                                        <%# WriteContext(Eval("CataLogID"))%>
                                                    </td>
                                           <%-- <td>
    ...
    <script type='text/javascript' src='ReportList.js?t=638136942053975016'></script>
</body>
