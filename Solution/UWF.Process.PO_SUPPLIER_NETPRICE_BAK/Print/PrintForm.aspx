...
<body>
   ...
   tablenamedetail="PROC_PO_SUPPLIER_NETPRICE_ITEMS" runat="server"></ui:userinfo>
                ...
                <div class="panel  "><%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.PO_SUPPLIER_NETPRICE_ITEMS") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                <tr>
                    ...
                    <td style="" class=" thlbl td_PRARTICLENAME"><%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.PRArticleName") %></td>
                ...
                <ult:Repeater ID="read_detail_PROC_PO_SUPPLIER_NETPRICE_ITEMS" runat="server">
                  <ItemTemplate>
                    <tr>
                       ...
                       <td class="Detail_tdtxt   td_PRARTICLENAME">
                                                        <ult:Label ID="fld_PRARTICLENAME"   data-field="PRARTICLENAME" runat="server" Text='<%#Eval("PRARTICLENAME")%>' Format="" ></ult:Label>
