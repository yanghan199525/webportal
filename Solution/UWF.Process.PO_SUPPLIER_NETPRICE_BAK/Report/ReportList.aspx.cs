...
namespace UWF.Process.PO_SUPPLIER_NETPRICE
{
    ...
    rpt.Source = "BizDB.select * from PROC_PO_SUPPLIER_NETPRICE where 1=1 "+process.GetReportViewSql    ("PO_SUPPLIER_NETPRICE",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("PO_SUPPLIER_NETPRICE");
    ExcelUtil.Export(dt);
    }
