<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="UWF.Process.PO_SUPPLIER_NETPRICE.ReportList" %>
...
<head>
    ...
    <title>PO_SUPPLIER_NETPRICE Report</title>
...
<body>
            ...
            <div class="app-page-title" style="height: 5rem; margin: 0; padding: 0;">
                <div class="page-title-wrapper pl-3 pr-3 mr-3" style="height: 4.5rem;">
                    <div class="page-title-heading">
                        ...
                        <div>
                            <div class="page-title-subheading"><h4>PO_SUPPLIER_NETPRICE <%= Lang.Get("Report") %></h4></div>
                        </div>
                    </div>
                ...
                <div class="card-body pb-2">
                                    ...
                                    <ult:TextBox ID="txt_APPLICANT" runat="server" CssClass="form-control" Destination="APPLICANT"></ult:TextBox>
                                            ...
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_IsAllow" runat="server" CssClass="form-control" Destination="IsAllow"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_Reasons" runat="server" CssClass="form-control" Destination="Reasons"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_CompanyCode" runat="server" CssClass="form-control" Destination="CompanyCode"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_TotalAmountOrder" runat="server" CssClass="form-control" Destination="TotalAmountOrder"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_TotalAmountSupplier" runat="server" CssClass="form-control" Destination="TotalAmountSupplier"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_TotalAmountDiffer" runat="server" CssClass="form-control" Destination="TotalAmountDiffer"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_BATCHNUMBER" runat="server" CssClass="form-control" Destination="BATCHNUMBER"></ult:TextBox>
                                                </div>
                                            </div>
                    ...
                    <div style="width: 100%; overflow-x: scroll;">
                        <table id="detailTable" class="table table-hover table-striped table-bordered mt-3">
                            ...
                            <tbody>
                                <ult:Repeater ID="rptList" OnItemCommand="rpSource_ItemCommand" Source="BizDB.PROC_PO_SUPPLIER_NETPRICE" PagerID="AspNetPager1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <%# Eval("REQUESTDATE")!=DBNull.Value?String.Format("{0:yyyy-MM-dd}", MyLib.ConvertUtil.ToDateTime(Eval("REQUESTDATE"))):""%>
                                                    ...
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("IsAllow")%>'>
                                                        <%# WriteContext(Eval("IsAllow"))%>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("Reasons")%>'>
                                                        <%# WriteContext(Eval("Reasons"))%>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("SupplierCode")%>'>
                                                        <%# WriteContext(Eval("SupplierCode"))%>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("SupplierName")%>'>
                                                        <%# WriteContext(Eval("SupplierName"))%>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("CompanyCode")%>'>
                                                        <%# WriteContext(Eval("CompanyCode"))%>
                                                    </td>
                                                    <td class="text-right">
                                                        <span class="autonumber"><%#Eval("TotalAmountOrder")%></span>
                                                    </td>
                                                    <td class="text-right">
                                                        <span class="autonumber"><%#Eval("TotalAmountSupplier")%></span>
                                                    </td>
                                                    <td class="text-right">
                                                        <span class="autonumber"><%#Eval("TotalAmountDiffer")%></span>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("BATCHNUMBER")%>'>
                                                        <%# WriteContext(Eval("BATCHNUMBER"))%>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("STATECODE")%>'>
                                                        <%# WriteContext(Eval("STATECODE"))%>
                                                    </td>
                                            <td>
    ...
    <script type='text/javascript' src='ReportList.js?t=638816260998520334'></script>
</body>
