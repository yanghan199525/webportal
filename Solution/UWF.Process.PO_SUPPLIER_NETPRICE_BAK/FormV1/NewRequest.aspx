...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PO_SUPPLIER_NETPRICE" processprefix="PON" tablename="PROC_PO_SUPPLIER_NETPRICE"
   tablenamedetail="PROC_PO_SUPPLIER_NETPRICE_ITEMS" runat="server"></ui:userinfo>
                        ...
                        <div class="panel-body form-table">
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ISALLOW" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_ISALLOW" data-type='string' title="" onblur="" data-field="ISALLOW"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_REASONS" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_REASONS" data-type='string' title="" onblur="" data-field="REASONS"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERCODE" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_SUPPLIERCODE" data-type='string' title="" onblur="" data-field="SUPPLIERCODE"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERNAME" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_SUPPLIERNAME" data-type='string' title="" onblur="" data-field="SUPPLIERNAME"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_COMPANYCODE" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_COMPANYCODE" data-type='string' title="" onblur="" data-field="COMPANYCODE"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TOTALAMOUNTORDER" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_TOTALAMOUNTORDER" data-type='number' title="" onblur="" data-field="TOTALAMOUNTORDER"   Variable="" ControlValue="" CssClass="form-control validate[custom[number]] " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TOTALAMOUNTSUPPLIER" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_TOTALAMOUNTSUPPLIER" data-type='number' title="" onblur="" data-field="TOTALAMOUNTSUPPLIER"   Variable="" ControlValue="" CssClass="form-control validate[custom[number]] " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TOTALAMOUNTDIFFER" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_TOTALAMOUNTDIFFER" data-type='number' title="" onblur="" data-field="TOTALAMOUNTDIFFER"   Variable="" ControlValue="" CssClass="form-control validate[custom[number]] " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_BATCHNUMBER" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_BATCHNUMBER" data-type='string' title="" onblur="" data-field="BATCHNUMBER"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_STATECODE" style="height:">
                                        ...
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_STATECODE" data-type='string' title="" onblur="" data-field="STATECODE"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class=" td_SUPPLIERCODE" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.SupplierCode").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_SUPPLIERCODE" title="" data-type='string' onblur=""  data-field="SUPPLIERCODE" CssClass="item-control  " ControlValue='<%#Eval("SUPPLIERCODE")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_BATCHNUMBER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.BATCHNUMBER").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_BATCHNUMBER" title="" data-type='string' onblur=""  data-field="BATCHNUMBER" CssClass="item-control  " ControlValue='<%#Eval("BATCHNUMBER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_PRARTICLECODE" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.PRArticleCode").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_PRARTICLECODE" title="" data-type='string' onblur=""  data-field="PRARTICLECODE" CssClass="item-control  " ControlValue='<%#Eval("PRARTICLECODE")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_PRARTICLENAME" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.PRArticleName").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_PRARTICLENAME" title="" data-type='string' onblur=""  data-field="PRARTICLENAME" CssClass="item-control  " ControlValue='<%#Eval("PRARTICLENAME")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_TAXNUMBER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.TaxNumber").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_TAXNUMBER" title="" data-type='string' onblur=""  data-field="TAXNUMBER" CssClass="item-control  " ControlValue='<%#Eval("TAXNUMBER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_GRRECEIVINGQUANTITY" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.GRReceivingQuantity").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_GRRECEIVINGQUANTITY" title="" data-type='number' onblur=""  data-field="GRRECEIVINGQUANTITY" CssClass="item-control validate[custom[number]] " ControlValue='<%#Eval("GRRECEIVINGQUANTITY")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_TAXRATEORDER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.TaxRateOrder").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_TAXRATEORDER" title="" data-type='string' onblur=""  data-field="TAXRATEORDER" CssClass="item-control  " ControlValue='<%#Eval("TAXRATEORDER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_TAXRATESUPPLIER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.TaxRateSupplier").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_TAXRATESUPPLIER" title="" data-type='string' onblur=""  data-field="TAXRATESUPPLIER" CssClass="item-control  " ControlValue='<%#Eval("TAXRATESUPPLIER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_TAXRATEDIFFER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.TaxRateDiffer").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_TAXRATEDIFFER" title="" data-type='string' onblur=""  data-field="TAXRATEDIFFER" CssClass="item-control  " ControlValue='<%#Eval("TAXRATEDIFFER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_NETPRICEORDER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.NetPriceOrder").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_NETPRICEORDER" title="" data-type='string' onblur=""  data-field="NETPRICEORDER" CssClass="item-control  " ControlValue='<%#Eval("NETPRICEORDER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_NETPRICESUPPLIER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.NetPriceSupplier").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_NETPRICESUPPLIER" title="" data-type='string' onblur=""  data-field="NETPRICESUPPLIER" CssClass="item-control  " ControlValue='<%#Eval("NETPRICESUPPLIER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_NETPRICEDIFFER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.NetPriceDiffer").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_NETPRICEDIFFER" title="" data-type='string' onblur=""  data-field="NETPRICEDIFFER" CssClass="item-control  " ControlValue='<%#Eval("NETPRICEDIFFER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_CONTRACTPRICEORDER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.ContractPriceOrder").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_CONTRACTPRICEORDER" title="" data-type='string' onblur=""  data-field="CONTRACTPRICEORDER" CssClass="item-control  " ControlValue='<%#Eval("CONTRACTPRICEORDER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_CONTRACTPRICESUPPLIER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.ContractPriceSupplier").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_CONTRACTPRICESUPPLIER" title="" data-type='string' onblur=""  data-field="CONTRACTPRICESUPPLIER" CssClass="item-control  " ControlValue='<%#Eval("CONTRACTPRICESUPPLIER")%>' runat="server">
                                                </ult:TextBox>

                                        </td>
                                        <td class=" td_CONTRACTPRICEDIFFER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_NETPRICE.ContractPriceDiffer").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_CONTRACTPRICEDIFFER" title="" data-type='string' onblur=""  data-field="CONTRACTPRICEDIFFER" CssClass="item-control  " ControlValue='<%#Eval("CONTRACTPRICEDIFFER")%>' runat="server">
                                                </ult:TextBox>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=9b95ea64-a543-4355-b30d-298214bee8fa'></script>
    <script type='text/javascript' src='NewRequest.js?t=71a98e8e-9d0e-4b3d-ae4d-52545596e97f'></script>
</body>
</html>
