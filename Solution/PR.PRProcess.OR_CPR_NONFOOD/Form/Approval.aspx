<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="PR.PRProcess.OR_CPR_NONFOOD.Approval" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="OR_CPR_NONFOOD" processpefix="OR_CPR" tablename="PROC_OR_CPR_NONFOOD"
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DELIVERYDATE" style="height:30px ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.OR_CPR_NONFOOD.DELIVERYDATE") %><span style='color: red'>*</span>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_OR_CPR_NONFOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="read_detail_PROC_OR_CPR_NONFOOD_ITEMS" runat="server">
                                    <itemtemplate>
                                        <tr>
                                            <td class="hidden">
        ...
        <btn:buttonlist id="ButtonList1" runat="server"></btn:buttonlist>
         <div class="hidden">
            <asp:TextBox ID="CheckUser" runat="server"></asp:TextBox>
        </div>
          <asp:HiddenField ID="hdDatetime" runat="server" />
    </form>

    <div id='div_lang' data-lang='<%=Lang.GetLang() %>'></div>
    <script type='text/javascript' src='Approval.js?t=f82ad019-beaa-4250-823c-8c23d93f75322'></script>
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
            var POAmount = $("#read_POAMOUNT").html();
            $("#read_POAMOUNT").html(thousands(POAmount));
