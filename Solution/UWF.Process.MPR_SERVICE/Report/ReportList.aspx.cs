...
namespace UWF.Process.MPR_SERVICE
{
    ...
    rpt.Source = "BizDB.select * from PROC_MPR_SERVICE where 1=1 "+process.GetReportViewSql    ("MPR_SERVICE",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("MPR_SERVICE");
    ExcelUtil.Export(dt);
    }
