...
namespace UWF.Process.MMPR_SERVICE
{
    ...
    rpt.Source = "BizDB.select * from PROC_MMPR_SERVICE where 1=1 "+process.GetReportViewSql    ("MMPR_SERVICE",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("MMPR_SERVICE");
    ExcelUtil.Export(dt);
    }
