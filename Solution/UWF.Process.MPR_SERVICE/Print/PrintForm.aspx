<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm.aspx.cs" Inherits="UWF.Process.MMPR_SERVICE.PrintForm" %>
...
<head>
    ...
    <title>MMPR_SERVICE</title>
</head>
<body>
    <form id="form1" runat="server">
        <div id="divmain">

                <ui:userinfo id="UserInfo1" processtitle="MMPR_SERVICE" processpefix="" tablename="PROC_MMPR_SERVICE"
   tablenamedetail="PROC_MMMPR_SERVICE_ITEMS" runat="server"></ui:userinfo>
                <div class="panel  hidden"><%=Lang.Get("UWF.Process.MMPR_SERVICE.MMPR_SERVICE") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                    <tr class="">
                        <td class="tdlbl tdl_SITECODE"><%=Lang.Get("UWF.Process.MMPR_SERVICE.SITECODE") %>：</td>
                ...
                <div class="panel  "><%=Lang.Get("UWF.Process.MMPR_SERVICE.MMMPR_SERVICE_ITEMS") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="" class=" thlbl td_ARTICLECODE"><%=Lang.Get("UWF.Process.MMPR_SERVICE.ARTICLECODE") %></td>
                </tr>
                <ult:Repeater ID="read_detail_PROC_MMMPR_SERVICE_ITEMS" runat="server">
                  <ItemTemplate>
                    <tr>
