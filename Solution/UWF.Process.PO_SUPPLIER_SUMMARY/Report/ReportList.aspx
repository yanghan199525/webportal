<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="UWF.Process.PO_SUPPLIER_SUMMARY.ReportList" %>
...
<head>
    ...
    <title>PO SUPPLIER SUMMARY Report</title>
    ...
    <form id="form1" runat="server">
        <div class="panel panel-default">
            <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>供应商汇总报表</span>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 padding-b-5">
                    <div class="form-group">
                        <div class="col-md-4">办理人:</div>
                        <div class="col-md-8">
                            <ult:TextBox ID="txt_ASSIGNEDTOUSER" runat="server" CssClass="form-control" Destination="ASSIGNEDTOUSER"></ult:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    ...
                    <tbody>
                        <ult:Repeater ID="rptList" Source="BizDB.PO_SUPPLIER_SUMMARY" PagerID="AspNetPager1" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                  ...
                                  <td>
                                    ...
                                    <td><%# Eval("COMPLETEDATE")!=DBNull.Value ? String.Format("{0:yyyy-MM-dd}", MyLib.ConvertUtil.ToDateTime(Eval("COMPLETEDATE"))) : ""%></td>
                                    <td><%#Eval("COMPANY")%></td>
                                    <td><%#Eval("BATCHNUMBER")%></td>
                                    <td><%#Eval("ASSIGNEDTOUSER")%></td>
                                    <td><%#Eval("PROCESSSUMMARY")%></td>
                                </tr>
                            </ItemTemplate>
                        </ult:Repeater>
                    </tbody>
