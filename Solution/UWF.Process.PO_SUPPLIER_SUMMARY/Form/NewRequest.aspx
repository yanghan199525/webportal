<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="UWF.Process.PO_SUPPLIER_SUMMARY.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS = Page.FindControl("fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS = Page.FindControl("fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS,1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PO_SUPPLIER_SUMMARY" processprefix="" tablename="PROC_PO_SUPPLIER_SUMMARY"
   tablenamedetail="PROC_PO_SUPPLIER_SUMMARY_ITEMS" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_BATCHNUMBER" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_BATCHNUMBER" data-type='string'  title="" onblur="checkExpression(this)" data-field="BATCHNUMBER"   Variable="BATCHNUMBER" ControlValue="" CssClass="form-control  " runat="server">
                    </ult:textbox>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PO_SUPPLIER_SUMMARY_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_PO_SUPPLIER_SUMMARY_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td class=" td_ISALLOW" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.IsAllow").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_ISALLOW"  title="" data-type='string' onblur="checkExpression(this)"  data-field="ISALLOW" CssClass="item-control  " ControlValue='<%#Eval("ISALLOW")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_REASONS" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.Reasons").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_REASONS"  title="" data-type='string' onblur="checkExpression(this)"  data-field="REASONS" CssClass="item-control  " ControlValue='<%#Eval("REASONS")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            ...
                                            <td class=" td_SUPPLIERNAME" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.SupplierName").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_SUPPLIERNAME"  title="" data-type='string' onblur="checkExpression(this)"  data-field="SUPPLIERNAME" CssClass="item-control  " ControlValue='<%#Eval("SUPPLIERNAME")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_COMPANYCODE" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.CompanyCode").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_COMPANYCODE"  title="" data-type='string' onblur="checkExpression(this)"  data-field="COMPANYCODE" CssClass="item-control  " ControlValue='<%#Eval("COMPANYCODE")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_TOTALAMOUNTORDER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.TotalAmountOrder").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_TOTALAMOUNTORDER"  title="" data-type='string' onblur="checkExpression(this)"  data-field="TOTALAMOUNTORDER" CssClass="item-control  " ControlValue='<%#Eval("TOTALAMOUNTORDER")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_TOTALAMOUNTDIFFER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.TotalAmountDiffer").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_TOTALAMOUNTDIFFER"  title="" data-type='string' onblur="checkExpression(this)"  data-field="TOTALAMOUNTDIFFER" CssClass="item-control  " ControlValue='<%#Eval("TOTALAMOUNTDIFFER")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_TOTALAMOUNTSUPPLIER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.TotalAmountSupplier").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_TOTALAMOUNTSUPPLIER"  title="" data-type='string' onblur="checkExpression(this)"  data-field="TOTALAMOUNTSUPPLIER" CssClass="item-control  " ControlValue='<%#Eval("TOTALAMOUNTSUPPLIER")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_STATECODE" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.STATECODE").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_STATECODE"  title="" data-type='string' onblur="checkExpression(this)"  data-field="STATECODE" CssClass="item-control  " ControlValue='<%#Eval("STATECODE")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PO_SUPPLIER_SUMMARY_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_PO_SUPPLIER_SUMMARY_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=6ec0c56a-c815-40dd-9925-652bd37f2623'></script>
</body>
</html>
