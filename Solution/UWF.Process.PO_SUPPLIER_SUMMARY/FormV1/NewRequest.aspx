...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PO_SUPPLIER_SUMMARY" processprefix="PSS" tablename="PROC_PO_SUPPLIER_SUMMARY"
   tablenamedetail="PROC_PO_SUPPLIER_SUMMARY_ITEMS" runat="server"></ui:userinfo>
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class=" td_REASONS" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.REASONS").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_REASONS" title="" data-type='radio' data-field="REASONS" runat="server" Text='<%#Eval("REASONS")%>' Format="" Width="90%"></ult:TextBox>
                                                </td>
                                                ...
                                                <td class=" td_TOTALAMOUNTORDER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.TOTALAMOUNTORDER").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_TOTALAMOUNTORDER" title="" data-type='string' data-field="TOTALAMOUNTORDER" runat="server" Text='<%#Eval("TOTALAMOUNTORDER")%>' Format="" Width="90%"></ult:Label>
                                                </td>
                                                 <td class=" td_TOTALAMOUNTSUPPLIER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.TOTALAMOUNTSUPPLIER").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_TOTALAMOUNTSUPPLIER" title="" data-type='string' data-field="TOTALAMOUNTSUPPLIER" runat="server" Text='<%#Eval("TOTALAMOUNTSUPPLIER")%>' Format="" Width="90%"></ult:Label>
                                                </td>
                                                <td class=" td_TOTALAMOUNTDIFFER" data-label='<%=Lang.Get("UWF.Process.PO_SUPPLIER_SUMMARY.TOTALAMOUNTDIFFER").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_TOTALAMOUNTDIFFER" title="" data-type='string' data-field="TOTALAMOUNTDIFFER" runat="server" Text='<%#Eval("TOTALAMOUNTDIFFER")%>' Format="" Width="90%"></ult:Label>
                                                </td>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=c559c621-be06-4aba-a1fe-c30d07e499d5'></script>
    <script type='text/javascript' src='NewRequest.js?t=cf3ec48a-c0f3-404a-b62a-9bf35f18dfe2'></script>
</body>
</html>
