<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="PR.PRProcess.PRHK_FOOD_NONFOOD.ReportList" %>
...
<head>
    ...
    <title>PRHK_FOOD_NONFOOD Report</title>
...
<body>
        ...
        <div class="panel panel-default">
            ...
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    ...
                    <tbody>
                        <ult:Repeater ID="rptList" Source="BizDB.PROC_PRHK_FOOD_NONFOOD" PagerID="AspNetPager1"
                            runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
    ...
    <script type='text/javascript' src='ReportList.js?t=637473493869148543'></script>
</body>
</html>
