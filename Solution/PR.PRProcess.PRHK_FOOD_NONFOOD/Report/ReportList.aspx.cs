...
namespace PR.PRProcess.PRHK_FOOD_NONFOOD
{
    public partial class ReportList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rpt.Source = "BizDB.select * from PROC_PRHK_FOOD_NONFOOD where 1=1 " + process.GetReportViewSql("PRHK_FOOD_NONFOOD",SessionLogic.GetLoginName()); 
        }
        protected void lbExport_Click(object sender, EventArgs e)
        {
            ...
            dt=ExportLogic.GetSchemaTable("PRHK_FOOD_NONFOOD", dt);
            ExcelUtil.Export(dt);
        }
    }
}