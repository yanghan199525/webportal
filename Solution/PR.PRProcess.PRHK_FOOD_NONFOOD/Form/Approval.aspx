<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="PR.PRProcess.PRHK_FOOD_NONFOOD.Approval" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
     <ui:userinfo id="UserInfo1" processtitle="PRHK_FOOD_NONFOOD" processpefix="HKCPR" tablename="PROC_PRHK_FOOD_NONFOOD"
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PRHK_FOOD_NONFOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="read_detail_PROC_PRHK_FOOD_NONFOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
    ...
    <script type='text/javascript' src='Approval.js?t=b0546059-eefd-41c2-90b6-2147d2a2c6a9'></script>
