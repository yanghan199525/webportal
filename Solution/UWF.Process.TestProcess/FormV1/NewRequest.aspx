<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="UWF.Process.TestProcess.NewRequest" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="TestProcess" processprefix="CS" tablename="PROC_TESTPROCESS"
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("UWF.Process.TestProcess.TestProcess") %>
                            </div>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=e62aeaeb-bc8a-4029-8497-30893ea37416'></script>
    <script type='text/javascript' src='NewRequest.js?t=459950ed-61d1-42c5-9613-4df3a38b8ef3'></script>
</body>
</html>
