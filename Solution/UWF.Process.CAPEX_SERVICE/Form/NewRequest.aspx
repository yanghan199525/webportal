...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS,1);
            }
        }
    </script>
</head>
<body>
   ...
   tablenamedetail="PROC_PROC_CAPEX_SERVICE_ITEMS" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CapexNumber" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_CAPEXNUMBER" data-type='string'  title="" onblur="checkExpression(this)" data-field="CAPEXNUMBER"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                    </ult:textbox>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ContractDate" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <div class="input-prepend input-group">
                         <ult:TextBox ID="fld_CONTRACTDATE"  title="" data-field="CONTRACTDATE" data-type="datetime" Format=""  Variable="" CssClass="form-control " runat="server">
                        </ult:textbox>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DepreciationDate" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <div class="input-prepend input-group">
                         <ult:TextBox ID="fld_DEPRECIATIONDATE"  title="" data-field="DEPRECIATIONDATE" data-type="datetime" Format=""  Variable="" CssClass="form-control " runat="server">
                        </ult:textbox>
                         <span class="add-on input-group-addon hidden-xs"><i class="fa fa-calendar"></i></span>
                     </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_Uploads" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_UPLOADS" data-type='string'  title="" onblur="checkExpression(this)" data-field="UPLOADS"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                    </ult:textbox>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_AMOUNT" data-type='string'  title="" onblur="checkExpression(this)" data-field="AMOUNT"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                    </ult:textbox>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PROC_CAPEX_SERVICE_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_PROC_CAPEX_SERVICE_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PROC_CAPEX_SERVICE_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_PROC_CAPEX_SERVICE_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=a7c9cc2e-2c8b-4706-ae16-62ffd5f9df92'></script>
</body>
</html>
