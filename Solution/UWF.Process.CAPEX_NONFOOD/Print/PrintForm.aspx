<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm.aspx.cs" Inherits="UWF.Process.HK_CAPEX_NONFOOD.PrintForm" %>
...
<body>
    <form id="form1" runat="server">
        <div id="divmain">
                ...
                <ui:userinfo id="UserInfo1" processtitle="HK_CAPEX_NONFOOD" processpefix="" tablename="PROC_HK_CAPEX_NONFOOD"
   tablenamedetail="PROC_HK_CAPEX_NONFOOD_ITEMS" runat="server"></ui:userinfo>
                <div class="panel  hidden"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.HK_CAPEX_NONFOOD") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                    <tr class="">
                        <td class="tdlbl tdl_SITECODE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.SITECODE") %>：</td>
                        <td class="tdtxt tdt_SITECODE">
                                                        <ult:Label ID="read_SITECODE"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_SITENAME"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.SITENAME") %>：</td>
                        <td class="tdtxt  tdt_SITENAME">
                                                        <ult:Label ID="read_SITENAME"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_AMOUNT"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.AMOUNT") %>：</td>
                        <td class="tdtxt tdt_AMOUNT">
                                                        <ult:Label ID="read_AMOUNT"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_CAPEXNUMBER"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.CapexNumber") %>：</td>
                        <td class="tdtxt  tdt_CAPEXNUMBER">
                                                        <ult:Label ID="read_CAPEXNUMBER"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_SUPPLIERCODE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.SupplierCode") %>：</td>
                        <td class="tdtxt tdt_SUPPLIERCODE">
                                                        <ult:Label ID="read_SUPPLIERCODE"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_SUPPLIERNAME"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.SupplierName") %>：</td>
                        <td class="tdtxt  tdt_SUPPLIERNAME">
                                                        <ult:Label ID="read_SUPPLIERNAME"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_CONTRACTDATE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.ContractDate") %>：</td>
                        <td class="tdtxt tdt_CONTRACTDATE">
                                                        <ult:Label ID="read_CONTRACTDATE"  Format="" runat="server"></ult:Label>
</td>
                        <td class="tdlbl  tdl_DEPRECIATIONDATE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.DepreciationDate") %>：</td>
                        <td class="tdtxt  tdt_DEPRECIATIONDATE">
                                                        <ult:Label ID="read_DEPRECIATIONDATE"  Format=""  runat="server"></ult:Label>
</td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl tdl_UPLOADS"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.Uploads") %>：</td>
                ...
                <div class="panel  "><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.HK_CAPEX_NONFOOD_ITEMS") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="" class=" thlbl td_ARTICLECODE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.ArticleCode") %></td>
                    <td style="" class=" thlbl td_ARTICLENAME"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.ArticleName") %></td>
                    <td style="" class=" thlbl td_FAMILYNAME"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.FamilyName") %></td>
                    <td style="" class=" thlbl td_PCPRICE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.PCPrice") %></td>
                    <td style="" class=" thlbl td_ORDERQTY"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.OrderQty") %></td>
                    <td style="" class=" thlbl td_ORDERUNIT"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.OrderUnit") %></td>
                    <td style="" class=" thlbl td_AMOUNT"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.Amount") %></td>
                    <td style="" class=" thlbl td_DELIVERYDATE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.DeliveryDate") %></td>
                    <td style="" class=" thlbl td_NEEDACCEPT"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.NeedAccept") %></td>
                    <td style="" class=" thlbl td_ASSETCLASS"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.AssetClass") %></td>
                    <td style="" class=" thlbl td_ACCEPTMARK"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.AcceptMark") %></td>
                    <td style="" class=" thlbl td_FAMILYCODE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.FamilyCode") %></td>
                    <td style="" class=" thlbl td_DEPRECIATIONSTARTDATE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.DepreciationStartDate") %></td>
                    <td style="" class=" thlbl td_BUYBACKTERM"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.BuybackTerm") %></td>
                    <td style="" class=" thlbl td_REMOVABLE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.Removable") %></td>
                    <td style="" class=" thlbl td_USEFULLIFE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.UsefulLife") %></td>
                    <td style="" class=" thlbl td_ACCEPTANCEREQUIRED"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.AcceptanceRequired") %></td>
                    <td style="" class=" thlbl td_COMMODITYCODE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.CommodityCode") %></td>
                    <td style="" class=" thlbl td_CONTRACTCLOSUREDATE"><%=Lang.Get("UWF.Process.HK_CAPEX_NONFOOD.ContractClosureDate") %></td>
                </tr>
                <ult:Repeater ID="read_detail_PROC_HK_CAPEX_NONFOOD_ITEMS" runat="server">
                  <ItemTemplate>
                    <tr>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=64570a75-8408-44de-8981-a1118b5462e2'></script>
    <script type='text/javascript' src='PrintForm.js?t=21178e69-b434-46a4-ae35-1ef5590357a8'></script>
