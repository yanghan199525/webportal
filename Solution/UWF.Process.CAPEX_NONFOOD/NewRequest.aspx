<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="UWF.Process.HK_CAPEX_NONFOOD.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_HK_CAPEX_NONFOOD_Items = Page.FindControl("fld_detail_PROC_HK_CAPEX_NONFOOD_Items") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_HK_CAPEX_NONFOOD_Items.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_HK_CAPEX_NONFOOD_Items = Page.FindControl("fld_detail_PROC_HK_CAPEX_NONFOOD_Items") as Ultimus.UWF.Form.WebControls.Repeater;
            if (fld_detail_PROC_HK_CAPEX_NONFOOD_Items.Items.Count == 0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_HK_CAPEX_NONFOOD_Items, 1);
            }
        }
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="HK_CAPEX_NONFOOD" processprefix="CPRN" tablename="PROC_HK_CAPEX_NONFOOD"
                ...
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title">
                            ...
                            <span class="padding-r-5"></span>
                            <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.HK_CAPEX_NONFOOD_Items") %>
                        </div>
                    ...
                    <div class="panel-body">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 5px; vertical-align: middle;" type="checkbox" id="ch_needaccept" onclick="ckneedaccept_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.NEEDACCEPT") %></span>
                                    </td>
                                    <td>
                                    ...
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 5px; vertical-align: middle;" type="checkbox" id="ch_buybackterm" onclick="ckbuybackterm_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.BUYBACKTERM") %></span>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 5px; vertical-align: middle;" type="checkbox" id="ch_removable" onclick="ckremovable_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.REMOVABLE") %></span>
                                    </td>
                        ...
                        <button id="btnAddCPRItems" onclick="addPRItemsRow('tb_HK_CAPEX_NONFOOD_ITEMS');return false;"
