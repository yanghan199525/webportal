<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="PR.PRProcess.PR_MONTHLY.ReportList" %>
...
<body>
        ...
        <div class="panel panel-default">
            ...
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    ...
                    <tbody>
                        <ult:Repeater ID="rptList" Source="BizDB.PROC_PR_MONTHLY" PagerID="AspNetPager1"
                            runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
    ...
    <script type='text/javascript' src='ReportList.js?t=637454538320420809'></script>
</body>
</html>
