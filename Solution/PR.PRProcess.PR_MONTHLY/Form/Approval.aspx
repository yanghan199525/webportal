<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="PR.PRProcess.PR_MONTHLY.Approval" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
     <ui:userinfo id="UserInfo1" processtitle="PR_MONTHLY" processpefix="PRM" tablename="PROC_PR_MONTHLY"
        ...
        <!--1.对Table做循环，判断单行,多行-->
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_MonthlyAmount" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                <ult:Label ID="read_MONTHLYAMOUNT" title="" Format=""  runat="server">
                </ult:Label>
            </div></div>
         </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PR_MONTHLY_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="read_detail_PROC_PR_MONTHLY_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
    ...
    <script type='text/javascript' src='Approval.js?t=7e8dbcc5-447c-4f18-8b70-2098f6edb3fc'></script>
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
             $("#read_MONTHLYAMOUNT").text(thousands($("#read_MONTHLYAMOUNT").text()));
             $("#read_BRANCHQUOTA").text(thousands( $("#read_BRANCHQUOTA").text()));
             $("#read_PercentageOfExcess").text(thousands( $("#read_PercentageOfExcess").text()));
