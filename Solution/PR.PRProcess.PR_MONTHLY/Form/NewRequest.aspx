<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="PR.PRProcess.PR_MONTHLY.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PR_MONTHLY_ITEMS = Page.FindControl("fld_detail_PROC_PR_MONTHLY_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_PR_MONTHLY_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PR_MONTHLY_ITEMS = Page.FindControl("fld_detail_PROC_PR_MONTHLY_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_PR_MONTHLY_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_PR_MONTHLY_ITEMS,1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PR_MONTHLY" processprefix="PRM" tablename="PROC_PR_MONTHLY"
   tablenamedetail="PROC_PR_MONTHLY_ITEMS" runat="server"></ui:userinfo>
            <!--End main table-->
            ...
            <!--1.对Table做循环，判断单行,多行-->
            <!--1.1单行-->
            <div class="row" id="div_panel_PR_MONTHLY">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.PR_MONTHLY.PR_MONTHLY") %>
                            </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DOCUMENTNO" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.DOCUMENTNO") %>:
             </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_PurchasingPurpose" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.PurchasingPurpose") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.SITECODE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.SITENAME") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DELIVERYDATE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.DELIVERYDATE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_MonthlyAmount" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.MonthlyAmount") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_MONTHLYAMOUNT" data-type='string'  title="" onblur="checkExpression(this)" data-field="MONTHLYAMOUNT"   Variable="" ControlValue="" CssClass="form-control   ReadOnly" runat="server">
                    </ult:textbox>
             </div></div>
         </div>
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_BranchQuota" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.BranchQuota") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_BRANCHQUOTA" data-type='string'  title="" onblur="checkExpression(this)" data-field="BRANCHQUOTA"   Variable="" ControlValue="" CssClass="form-control   ReadOnly" runat="server">
                    </ult:textbox>
             </div></div>
         </div>
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_PercentageOfExcess" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.PercentageOfExcess") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_PERCENTAGEOFEXCESS" data-type='string'  title="" onblur="checkExpression(this)" data-field="PERCENTAGEOFEXCESS"   Variable="" ControlValue="" CssClass="form-control   ReadOnly" runat="server">
                    </ult:textbox>
             </div></div>
         </div>
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_Requirement" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.Requirement") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-12 col-sm-6 col-xs-12 form-cell " id="div_field_APPREMARK" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.APPREMARK") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.APPROVEDATE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_MONTHLY.APPROVE") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
            ...
            <!--1.2多行-->
                    <!--Start Item table-->
            <div class="row" id="div_panel_PR_MONTHLY_ITEMS">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("PR.PRProcess.PR_MONTHLY.PR_MONTHLY_ITEMS") %></div>
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PR_MONTHLY_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                                        <input id="tb_PR_MONTHLY_ITEMS_rowCount" type="text" runat="server" />
                                    </td>
                                    <td class="th_no" style="width:50px">
                                        <%=Lang.Get("No") %>
                                    </td>
                                    <td style=""  class="hidden td_ARTICLECODE"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.ARTICLECODE") %></td>
                                    <td style=""  class=" td_ARTICLENAME"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.ARTICLENAME") %></td>
                                    <td style=""  class="hidden td_SUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.SUBSUBFAMILYCODE") %></td>
                                    <td style=""  class=" td_SUBSUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.SUBSUBFAMILYNAME") %></td>
                                    <td style=""  class=" td_ORDERUNIT"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.ORDERUNIT") %></td>
                                    <td style=""  class=" td_SITEPRICE"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.SITEPRICE") %></td>
                                    <td style=""  class=" td_ORDERQUANTITY"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.ORDERQUANTITY") %></td>
                                    <td style=""  class=" td_SUBTOTALAMOUNT"><%=Lang.Get("PR.PRProcess.PR_MONTHLY.SUBTOTALAMOUNT") %></td>
                                    <td style="width:60px"><%=Lang.Get("Action") %></td>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_PR_MONTHLY_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td class="hidden td_ARTICLECODE" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.ARTICLECODE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ARTICLENAME" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.ARTICLENAME").Split('<')[0] %>'>
                                            ...
                                            <td class="hidden td_SUBSUBFAMILYCODE" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.SUBSUBFAMILYCODE").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SUBSUBFAMILYNAME" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.SUBSUBFAMILYNAME").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_ORDERUNIT" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.ORDERUNIT").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SITEPRICE" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.SITEPRICE").Split('<')[0] %>'>
                                                    <ult:TextBox ID="fld_SITEPRICE"  title="" data-type='string' onblur="checkExpression(this)"  data-field="SITEPRICE" CssClass="item-control  " ControlValue='<%#Eval("SITEPRICE")%>' runat="server" >
                                                    </ult:TextBox>
                                            </td>
                                            <td class=" td_ORDERQUANTITY" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.ORDERQUANTITY").Split('<')[0] %>'>
                                            ...
                                            <td class=" td_SUBTOTALAMOUNT" data-label='<%=Lang.Get("PR.PRProcess.PR_MONTHLY.SUBTOTALAMOUNT").Split('<')[0] %>'>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PR_MONTHLY_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_PR_MONTHLY_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=1133997d-77ba-4f80-a7b2-5d8683aecdca'></script>
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
             $("#fld_MONTHLYAMOUNT").next("span").text(thousands($("#fld_MONTHLYAMOUNT").val()));
             $("#fld_BRANCHQUOTA").next("span").text(thousands($("#fld_BRANCHQUOTA").val()));
             $("#fld_PercentageOfExcess").next("span").text(thousands($("#fld_PercentageOfExcess").val()));
             $("#tb_PR_MONTHLY_ITEMS").find("thead").find("td:last").addClass("hidden");
             $("#tb_PR_MONTHLY_ITEMS").find("tbody").find("td:last").addClass("hidden");
