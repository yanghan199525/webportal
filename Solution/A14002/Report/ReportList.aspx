<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="A14002.ReportList" %>
...
<head>
    ...
    <title>TestProcess Report</title>
...
<body>
            ...
            <div class="app-page-title" style="height: 5rem; margin: 0; padding: 0;">
                <div class="page-title-wrapper pl-3 pr-3 mr-3" style="height: 4.5rem;">
                    <div class="page-title-heading">
                        ...
                        <div>
                            <div class="page-title-subheading"><h4>测试框架流程 <%= Lang.Get("Report") %></h4></div>
                        </div>
                    </div>
                ...
                <div class="card-body pb-2">
                    ...
                    <div style="width: 100%; overflow-x: scroll;">
                        <table id="detailTable" class="table table-hover table-striped table-bordered mt-3">
                            ...
                            <tbody>
                                <ult:Repeater ID="rptList" OnItemCommand="rpSource_ItemCommand" Source="BizDB.PROC_TESTPROCESS" PagerID="AspNetPager1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <%# Eval("REQUESTDATE")!=DBNull.Value?String.Format("{0:yyyy-MM-dd}", MyLib.ConvertUtil.ToDateTime(Eval("REQUESTDATE"))):""%>
                                                    ...
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("test1")%>'>
                                                        <%# WriteContext(Eval("test1"))%>
                                                    </td>
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("test2")%>'>
                                                        <%# WriteContext(Eval("test2"))%>
                                                    </td>
                                            <td>
    ...
    <script type='text/javascript' src='ReportList.js?t=637707565444103043'></script>
</body>
