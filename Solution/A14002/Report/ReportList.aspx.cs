...
namespace A14002
{
    ...
    rpt.Source = "BizDB.select * from PROC_TESTPROCESS where 1=1 "+process.GetReportViewSql    ("TestProcess",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("TestProcess");
    ExcelUtil.Export(dt);
    }
