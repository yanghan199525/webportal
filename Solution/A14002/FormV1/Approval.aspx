<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="A14002.Approval" %>
...
<body>
                        ...
                        <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TEST1" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_TEST1" title="1111" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TEST2" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_TEST2" title="" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=34245c83-35ec-4669-8397-b1abf1095c22'></script>
    <script type='text/javascript' src='Approval.js?t=eb6c1e12-14b3-4a4b-afed-1fe165f0350b'></script>
</body>
</html>
