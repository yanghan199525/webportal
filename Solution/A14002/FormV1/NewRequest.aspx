<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="A14002.NewRequest" %>
...
<body>
    ...
    tablenamedetail="" runat="server"></ui:userinfo>
            ...
            <!--1.对Table做循环，判断单行,多行-->
            <!--1.1单行-->
            <div class="row" id="div_panel_TestProcess">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-table">
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TEST1" style="height:">
                                        <div class="form-label">
                                            <%=Lang.Get("A14002.test1") %>:
                                        </div>
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_TEST1" data-type='string' title="1111" onblur="" data-field="TEST1"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_TEST2" style="height:">
                                        <div class="form-label">
                                            <%=Lang.Get("A14002.test2") %>:
                                        </div>
                                        <div class="form-field">
                                            <div class="form-ctl">
                                                    <ult:TextBox ID="fld_TEST2" data-type='string' title="" onblur="" data-field="TEST2"   Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                                    </ult:TextBox>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=df1e5c61-4cc3-43dd-9796-b393d05964ec'></script>
    <script type='text/javascript' src='NewRequest.js?t=0c335d55-77b6-4d42-9582-4842f61f4b88'></script>
</body>
</html>
