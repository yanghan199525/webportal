...
namespace PR.PRProcess.CPR_FOOD
{
    public partial class ReportList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var oldCount = 200;
            var newCount = 200;
            rpt.Source = string.Format(@"BizDB.SELECT
          h.FORMID,
        ...
        FROM
          PROC_CPR_FOOD h
          inner join
             WF_APPROVALHISTORY WF
         on  h.FORMID = WF.FORMID
        AND h.SITECODE = '{0}'
       ...
       SELECT
        ...
        HAVING h.FORMID = MAX(h.FORMID)", pcCode, empNo);
