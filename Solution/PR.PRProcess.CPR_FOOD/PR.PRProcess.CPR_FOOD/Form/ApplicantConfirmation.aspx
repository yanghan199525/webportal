<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ApplicantConfirmation.aspx.cs" Inherits="PR.PRProcess.CPR_FOOD.ApplicantConfirmation" %>
...
<body>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height: ">
                            ...
                            <div class="form-field">
                                <div class="form-ctl">
                                    ...
                                    <ult:TextBox ID="fld_APPROVEDATE" data-type='string' title="" onblur="checkExpression(this)" data-field="APPREMARK" Variable="" ControlValue="" CssClass="form-control  " runat="server">
                                    </ult:TextBox>
    ...
    <script type='text/javascript' src='Approval.js?t=585335ea-6014-4d42-bc76-dcd20607ac90'></script>
</body>
</html>
