<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleList.aspx.cs" Inherits="PR.PRProcess.CPR_FOOD.ArticleList" %>
                        ...
                        <asp:Repeater ID="ArticleSource" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" style="cursor:pointer" class="OrderLimt" value="<%#Eval("OrderLimit")!=DBNull.Value?Convert.ToDouble(Eval("OrderLimit")).ToString("f2"):"0.00"%>" />
                                    </td>
                                    ...
                                    <td style="display:none" class="TaxRate"><%#Eval("IsOneTimeUsing")%></td>
...
<%=WebUtil.IncludeJsV3() %>
  <script type='text/javascript' src='ArticleList.js?t=dc64a1ef-95e5-4fb4-a793-a14f354d8a43'></script>
</body>
</html>
