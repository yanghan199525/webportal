...
<ult:DropDownList ID="fld_INVOICETYPE" title="" onblur="checkExpression(this)" data-field="INVOICETYPE" Variable="" CssClass="form-control validate[required]" Source="DataSource.SODEXO_发票" Filter="" ControlValue='<%#Eval("INVOICETYPE")%>' runat="server">
                                            ...
                                            <td class="td_INVOICEPATH" data-label='<%=Lang.Get("PR.PRProcess.CPR_FOOD.INVOICEPATH").Split('<')[0] %>'>
                                                <ult:TextBox ID="fld_INVOICEPATH" title="" data-type='string' onblur="checkExpression(this)" data-field="INVOICEPATH" CssClass="item-control-invoice-path validate[required] ReadOnly" ControlValue='<%#Eval("INVOICEPATH")%>' runat="server">
    ...
    <script type='text/javascript' src='NewRequest.js?t=dc64a1ef-95e5-4fb4-a793-a499ySko999er29'></script>
</body>
