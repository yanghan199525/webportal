    ...
    public partial class Approval : System.Web.UI.Page
    {
        ...
        public string getDeliveryDate(string ProcessName, string Incident, string TaskID)
        {
            ...
            try
            {
                ...
                {
                    DataTable PROC_CPR_FOOD = DataAccess.Instance("BizDB").ExecuteDataTable("SELECT * FROM PROC_CPR_FOOD WHERE PROCESSNAME='" + ProcessName + "' AND INCIDENT=" + Incident);
        ...
        //protected void userInfo_AfterLoadData(object sender, EventArgs e)
        //{
        //    ButtonList buttonList1 = Page.FindControl("ButtonList1") as ButtonList;
        //    Button btnReturn = buttonList1.FindControl("btnReturn") as Button;
        //    //btnReturn.Text = Lang.Get("Reject");
        //}

         [WebMethod]
        public static bool ValidaeDeliverydate(string Deliverydate)
        {
            string Value = string.Format("{0} 18:00:00", DateTime.Now.AddDays(1).ToString("yyyy-MM-dd"));
            DateTime date_DELIVERYDATE = Convert.ToDateTime(Deliverydate);
