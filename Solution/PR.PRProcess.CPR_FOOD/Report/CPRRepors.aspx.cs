...
{
    public partial class CPRRepors : System.Web.UI.Page
    {
    ...
    AAA.APPLICANT, AAA.APPLICANTACCOUNT, AAA.APPLICANTCODE, AAA.APPLICANTTEL,
    AAA.REQUESTDATE, AAA.COMPLETEDATE, AAA.DEPARTMENT, AAA.DEPARTMENTID,
    AAA.COMPANY, AAA.COSTCENTER, AAA.PROCESSSUMMARY, AAA.STATUS,
    AAA.APPLYPURPOSE, AAA.SUPPLIERTYPE, AAA.SITECODE, AAA.SITENAME,
    AAA.DELIVERYDATE, AAA.SUPPLIERCODE, AAA.SUPPLIERNAME, AAA.ASSETTYPE,
    AAA.AMOUNT, AAA.APPREMARK, AAA.APPROVEDATE, AAA.PCCOMPCODE,
    AAA.APPLYPURPOSETXT, AAA.SUPPLIERTYPETXT, AAA.ASSETTYPETXT,
    AAA.CPRFAMILYCODE, AAA.OVERTIME, AAA.PURCHASINGAGENT,
    AAA.ONLINEORSUPERMARKET, AAA.USER_SIGNEDAPPROVER, AAA.USER_SIGNEDAPPROVER2,
    AAA.USER_SIGNEDAPPROVER3, AAA.USER_SIGNEDAPPROVERNAME,
    AAA.USER_SIGNEDAPPROVER2NAME, AAA.USER_SIGNEDAPPROVER3NAME,
    AAA.SIGNEDAPPROVERNUMBER, AAA.DELIVERY, AAA.APPROVE,
    WF.ACTION,BATCHNUMBER
FROM(
    --1.使用 UNION ALL 替代 UNION，消除全局去重开销
    -- 2.将过滤条件下推，尽早减少参与排序的数据量
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    FROM PROC_CPR_FOOD
    WHERE SITECODE = '{0}' AND APPLICANTACCOUNT = '{1}' AND INCIDENT <> -1 and BATCHNUMBER is not null
    UNION ALL
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    ...
    UNION ALL
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    FROM PROC_CPR_SERVICE
    WHERE SITECODE = '{0}' AND APPLICANTACCOUNT = '{1}' AND INCIDENT <> -1 and BATCHNUMBER is not null
) AS AAA
-- 3.依然使用 CROSS APPLY 高效关联最新的审批历史
CROSS APPLY(
    SELECT TOP(1) ACTION
    ...
    ORDER BY ID DESC
            ...
            drafts.Source = string.Format(@"BizDB.SELECT 
    AAA.FORMID, AAA.PROCESSNAME, AAA.INCIDENT, AAA.DOCUMENTNO,
    AAA.CREATEBY, AAA.CREATEBYACCOUNT, AAA.CREATEBYCODE,
    AAA.APPLICANT, AAA.APPLICANTACCOUNT, AAA.APPLICANTCODE, AAA.APPLICANTTEL,
    AAA.REQUESTDATE, AAA.COMPLETEDATE, AAA.DEPARTMENT, AAA.DEPARTMENTID,
    ...
    AAA.USER_SIGNEDAPPROVER3, AAA.USER_SIGNEDAPPROVERNAME,
    AAA.USER_SIGNEDAPPROVER2NAME, AAA.USER_SIGNEDAPPROVER3NAME,
    AAA.SIGNEDAPPROVERNUMBER, AAA.DELIVERY, AAA.APPROVE,BATCHNUMBER
FROM(
    --1.使用 UNION ALL 替代 UNION，消除全局去重开销
    -- 2.将过滤条件下推，尽早减少参与排序的数据量
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    FROM PROC_CPR_FOOD
    WHERE SITECODE = '{0}' AND INCIDENT IN(-1, -2) and BATCHNUMBER is not null
    UNION ALL
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    FROM PROC_CPR_NONFOOD
    WHERE SITECODE = '{0}' AND INCIDENT IN(-1, -2) and BATCHNUMBER is not null
...
-- 3.依然使用显式 INNER JOIN 关联草稿表
INNER JOIN WF_DRAFT AS WF_D ON AAA.FORMID = WF_D.FORMID", pcCode);
                 drafts.Sort = "REQUESTDATE DESC";
    ...
    AAA.USER_SIGNEDAPPROVER2NAME, AAA.USER_SIGNEDAPPROVER3NAME, 
    AAA.SIGNEDAPPROVERNUMBER, AAA.DELIVERY, AAA.APPROVE,
    CL.SYNCSTATUS, CL.ERRORMSG, CL.CREATEDATE,BATCHNUMBER
FROM (
    -- 1. 使用 UNION ALL 替代 UNION，消除全局去重开销
    -- 2. 将过滤条件下推，尽早减少参与排序的数据量
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    FROM PROC_CPR_FOOD
    WHERE SITECODE = '{0}' AND APPLICANTACCOUNT = '{1}' AND INCIDENT <> -1 AND REQUESTDATE > DATEADD(DAY, -60, GETDATE())  and BATCHNUMBER is not null
    UNION ALL
    SELECT FORMID, PROCESSNAME, INCIDENT, DOCUMENTNO, CREATEBY, CREATEBYACCOUNT, CREATEBYCODE, APPLICANT, APPLICANTACCOUNT, APPLICANTCODE, APPLICANTTEL, REQUESTDATE, COMPLETEDATE, DEPARTMENT, DEPARTMENTID, COMPANY, COSTCENTER, PROCESSSUMMARY, STATUS, APPLYPURPOSE, SUPPLIERTYPE, SITECODE, SITENAME, DELIVERYDATE, SUPPLIERCODE, SUPPLIERNAME, ASSETTYPE, AMOUNT, APPREMARK, APPROVEDATE, PCCOMPCODE, APPLYPURPOSETXT, SUPPLIERTYPETXT, ASSETTYPETXT, CPRFAMILYCODE, OVERTIME, PURCHASINGAGENT, ONLINEORSUPERMARKET, USER_SIGNEDAPPROVER, USER_SIGNEDAPPROVER2, USER_SIGNEDAPPROVER3, USER_SIGNEDAPPROVERNAME, USER_SIGNEDAPPROVER2NAME, USER_SIGNEDAPPROVER3NAME, SIGNEDAPPROVERNUMBER, DELIVERY, APPROVE,BATCHNUMBER
    FROM PROC_CPR_NONFOOD
    WHERE SITECODE = '{0}' AND APPLICANTACCOUNT = '{1}' AND INCIDENT <> -1 AND REQUESTDATE > DATEADD(DAY, -60, GETDATE())   and BATCHNUMBER is not null
...
-- 3. 依然使用 CROSS APPLY 高效关联最新的日志记录
CROSS APPLY (
    SELECT TOP (1) SYNCSTATUS, ERRORMSG, CREATEDATE
    FROM PROC_CPR_LOG
    WHERE EXT01 = AAA.PROCESSNAME AND EXT02 = AAA.INCIDENT AND CREATEDATE > DATEADD(DAY, -60, GETDATE())
    ORDER BY CREATEDATE DESC
) AS CL
-- 4. 全量输出时，必须显式指定排序规则以保证结果集有序
WHERE CL.SYNCSTATUS = 0", pcCode, empNo);
