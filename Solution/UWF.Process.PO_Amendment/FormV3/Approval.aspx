...
<head>
    ...
    <script runat="server">
        ...
        {
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_PO_AMENDMENT_ITEMS = Page.FindControl("read_detail_PROC_PO_AMENDMENT_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            read_detail_PROC_PO_AMENDMENT_ITEMS.AfterBind += new System.EventHandler(AfterBind);
            AfterLoad();
        }
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_PO_AMENDMENT_ITEMS = Page.FindControl("read_detail_PROC_PO_AMENDMENT_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(read_detail_PROC_PO_AMENDMENT_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, read_detail_PROC_PO_AMENDMENT_ITEMS,1);
            }
        }
...
<body>
   ...
   tablenamedetail="PROC_PO_AMENDMENT_ITEMS" runat="server"></ui:userinfo>
                        ...
                        <div class="panel-body form-table">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height:">
                               ...
                               <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_ADJUSTDOCUMENTNO" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_ADJUSTDOCUMENTNO" title="" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_INITDELIVERYDATE" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_INITDELIVERYDATE" title="" data-type='string' Format="" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_INITAMOUNT" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_INITAMOUNT" title="" Format="" CssClass="autonumber" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_AMOUNT" style="height:">
                                    ...
                                    <div class="form-field">
                                        <div class="form-ctl">
                                                <ult:Label ID="read_AMOUNT" title="" Format="" CssClass="autonumber" Variable="" runat="server">
                                                </ult:Label>
                                        </div>
                                    </div>
                            ...
                            <div class="inputContainer padding-t-5" style="width:100%">
                                ...
                                <table id="tb_PO_AMENDMENT_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class="hidden td_SUBSUBFAMILYCE" data-label='<%=Lang.Get("UWF.Process.PO_Amendment.SUBSUBFAMILYCE").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_SUBSUBFAMILYCE" title="" data-type='string' data-field="SUBSUBFAMILYCE" runat="server" Text='<%#Eval("SUBSUBFAMILYCE")%>' Format="" Width="90%"></ult:Label>
                                        </td> 
                                        ...
                                        <td class="hidden td_SITEPRICE" data-label='<%=Lang.Get("UWF.Process.PO_Amendment.SITEPRICE").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_SITEPRICE" title="" data-type='number' data-field="SITEPRICE" runat="server" Text='<%#Eval("SITEPRICE")%>' Format="" Width="90%"></ult:Label>
                                        </td> 
                                        <td class=" td_INITORDERQUANTITY" data-label='<%=Lang.Get("UWF.Process.PO_Amendment.INITORDERQUANTITY").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_INITORDERQUANTITY" title="" data-type='number' data-field="INITORDERQUANTITY" runat="server" Text='<%#Eval("INITORDERQUANTITY")%>' Format="" Width="90%"></ult:Label>
                                        </td> 
                                        <td class=" td_ORDERQUANTITY" style="color:red;" data-label='<%=Lang.Get("UWF.Process.PO_Amendment.ORDERQUANTITY").Split('<')[0] %>'>
                                             ...
                                             <td class=" td_AdjustmentQuantity"  style="color:red;" data-label='<%=Lang.Get("UWF.Process.PO_Amendment.AdjustmentQuantity").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_AdjustmentQuantity" title="" data-type='number' data-field="AdjustmentQuantity" runat="server" Text='<%#Eval("AdjustmentQuantity")%>' Format="" Width="90%"></ult:Label>
                                        </td>
                                        <td class="hidden td_SUBTOTALAMOUNT" data-label='<%=Lang.Get("UWF.Process.PO_Amendment.SUBTOTALAMOUNT").Split('<')[0] %>'>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=ba568ac6-07e7-4da2-978e-f292a5fedbc0'></script>
    <script type='text/javascript' src='Approval.js?t=654f0490-a3b8-4c39-8884-9a645b0220b521'></script>
</body>
</html>
