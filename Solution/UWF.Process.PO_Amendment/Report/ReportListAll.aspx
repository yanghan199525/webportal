<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportListAll.aspx.cs" Inherits=" UWF.Process.PO_AMENDMENT.ReportListAll" %>
...
<head>
    ...
    <title>PO_AMENDMENT Report</title>
        ...
        <div class="panel panel-default">
            ...
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    ...
                    <tbody>
                        <ult:Repeater ID="po_rptList" Source="BizDB.PROC_PO_AMENDMENT" PagerID="AspNetPager1"
                            runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a target="_blank" href="javascript:void(0)" onclick="javascript:objReport.openForm('<%#Eval("FormID") %>','<%#Eval("ProcessName") %>','<%#Eval("Incident") %>','<%#Eval("CREATEBY") %>');return false;" style="cursor:head">
                                            <%#Eval("DOCUMENTNO")%>
                                            </a>
                                    </td>
                                    <td>
                                         <%#Eval("ACTION").ToString().Contains("拒绝")?"已拒绝":Eval("ACTION").ToString().Contains("作废")?"已作废": MyLib.ConvertUtil.ToDateTime(Eval("COMPLETEDATE"))==Convert.ToDateTime("1901-01-01 00:00:00.000")?"已退回": MyLib.ConvertUtil.ToDateTime(Eval("COMPLETEDATE"))!=Convert.ToDateTime("1900-01-01 00:00:00.000")?"已完成":"审批中"%>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <asp:LinkButton ID="PO_lbHastenWork" runat="server" CommandArgument='<%#Eval("ProcessName")+","+Eval("Incident")+","+Eval("COMPLETEDATE")+","+Eval("DOCUMENTNO")+","+Eval("ACTION")%>' OnClick="PO_lbHastenWork_Click">催办</asp:LinkButton>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </ult:Repeater>
