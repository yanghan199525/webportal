<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPRItemPage.aspx.cs" Inherits="PR.PRProcess.HK_CPR_NONFOOD.AddPRItemPage" %>
...
<body>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD_Items") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.APPLYREASON") %><span style='color: red'>*</span>:
                                </div>
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.FAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBSUBFAMILYNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUPPLIERNAME") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUPPLIERCODE") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_HISTORYARTICLELIST" style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ARTICLENAME") %>:--%>
                                    <%=Lang.Get("PPR.PRProcess.HK_CPR_NONFOOD.HISTORYARTICLELIST") %>:
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.OTHERARTICLENAME") %>:--%>
                                    <%--其他物品名称:--%>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ARTICLENAME") %>:
                                </div>
                                <div class="form-field">
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.UNITINFORMATION") %>
                                <%--单位--%>
                            </div>
                        ...
                        <div class="panel-body form-table">
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ORDERUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.UNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERTYPE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.CONSUMPTIONUNIT") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.CONVERSION") %><span style='color: red'>*</span>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.NETVOMULE") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%--<%=Lang.Get("PR.PRProcess.CPR_NONFOOD.NETWEIGHTUNIT") %>:--%>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.NETVOMULEUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_GROSSWEIGHT" style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.GROSSWEIGHT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                            ...
                            <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " style="height: ">
                                <div class="form-label">
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.GROSSWEIGHTUNIT") %>:
                                </div>
                                <div class="form-field">
                                    <div class="form-ctl">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-title">
                                <div class="fa-title">
                                    <i class="fa fa-check-square-o"></i><span class="padding-r-5"></span>
                                    <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ORDERINGINFORMATION") %>
                                    <%--采购信息--%>
                                </div>
                            ...
                            <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CPRNO" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SITEPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_NETNETPRICE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.NETNETPRICE") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
                                ...
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_APPLYPURPOSE" style="height: ">
                                    <div class="form-label">
                                        <%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ORDERQUANTITY") %><span style='color: red'>*</span>:
                                    </div>
                                    <div class="form-field">
                                        <div class="form-ctl">
    ...
    <script type='text/javascript' src='AddPRItemPage_1122.js?t=7a9a1d87-03c3-4f71-887c-881c71413681'></script>
