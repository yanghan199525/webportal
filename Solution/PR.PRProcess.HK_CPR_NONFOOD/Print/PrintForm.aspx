<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm.aspx.cs" Inherits="PR.PRProcess.HK_CPR_NONFOOD.PrintForm" %>
...
<body>
    ...
    <div id="divmain">
            ...
            <div class="panel  hidden"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.HK_CPR_NONFOOD") %></div>
            <table border="1" style="width: 100%; border-collapse: collapse;">
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.APPLYPURPOSE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_APPLYPURPOSE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUPPLIERTYPE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SUPPLIERTYPE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SITECODE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SITECODE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SITENAME") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SITENAME"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.DELIVERYDATE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_DELIVERYDATE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUPPLIERCODE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SUPPLIERCODE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUPPLIERNAME") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SUPPLIERNAME"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ASSETTYPE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_ASSETTYPE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.AMOUNT") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_AMOUNT"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.APPREMARK") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_APPREMARK"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.CPRFAMILYCODE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_CPRFAMILYCODE"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.USER_SignedApproverName") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_USER_SIGNEDAPPROVERNAME"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.USER_SignedApproverName2") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_USER_SIGNEDAPPROVERNAME2"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.USER_SignedApproverName3") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_USER_SIGNEDAPPROVERNAME3"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SIGNEDAPPROVERNUMBER") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_SIGNEDAPPROVERNUMBER"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.APPROVE") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_APPROVE"   Format=""  runat="server">                </ult:Label></td>
                    </tr>
                    <tr class="">
                        <td class="tdlbl"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.FIXEDASSETS") %>：</td>
                        <td class="tdtxt"><ult:Label ID="read_FIXEDASSETS"  Format=""  runat="server">                </ult:Label></td>
                        <td class="tdlbl"></td>
                        <td class="tdtxt"></td>
                    </tr>
            </table>
            <div class="panel  "><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.HK_CPR_NONFOOD_ITEMS") %></div>
            <table border="1" style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="" class=" thlbl td_APPLYREASON"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.APPLYREASON") %></td>
                <td style="" class="hidden thlbl td_FAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.FAMILYCODE") %></td>
                <td style="" class="hidden thlbl td_FAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.FAMILYNAME") %></td>
                <td style="" class="hidden thlbl td_SUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBFAMILYCODE") %></td>
                <td style="" class="hidden thlbl td_SUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBFAMILYNAME") %></td>
                <td style="" class="hidden thlbl td_SUBSUBFAMILYCODE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBSUBFAMILYCODE") %></td>
                <td style="" class=" thlbl td_SUBSUBFAMILYNAME"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBSUBFAMILYNAME") %></td>
                <td style="" class=" thlbl td_ARTICLENAME"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ARTICLENAME") %></td>
                <td style="" class="hidden thlbl td_ARTICLECODE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ARTICLECODE") %></td>
                <td style="" class=" thlbl td_ORDERUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ORDERUNIT") %></td>
                <td style="" class="hidden thlbl td_UNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.UNIT") %></td>
                <td style="" class="hidden thlbl td_CONSUMPTIONUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.CONSUMPTIONUNIT") %></td>
                <td style="" class="hidden thlbl td_CONVERSION"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.CONVERSION") %></td>
                <td style="" class="hidden thlbl td_STOCK"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.STOCK") %></td>
                <td style="" class="hidden thlbl td_NETVOMULE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.NETVOMULE") %></td>
                <td style="" class="hidden thlbl td_GROSSWEIGHT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.GROSSWEIGHT") %></td>
                <td style="" class="hidden thlbl td_NETVOMULEUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.NETVOMULEUNIT") %></td>
                <td style="" class="hidden thlbl td_GROSSWEIGHTUNIT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.GROSSWEIGHTUNIT") %></td>
                <td style="" class=" thlbl td_SITEPRICE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SITEPRICE") %></td>
                <td style="" class=" thlbl td_ORDERQUANTITY"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ORDERQUANTITY") %></td>
                <td style="" class="hidden thlbl td_ORDERUNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.ORDERUNITVALUE") %></td>
                <td style="" class=" thlbl td_UNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.UNITVALUE") %></td>
                <td style="" class="hidden thlbl td_CONSUMPTIONUNITVALUE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.CONSUMPTIONUNITVALUE") %></td>
                <td style="" class=" thlbl td_SUBTOTALAMOUNT"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.SUBTOTALAMOUNT") %></td>
                <td style="" class="hidden thlbl td_NETNETPRICE"><%=Lang.Get("PR.PRProcess.HK_CPR_NONFOOD.NETNETPRICE") %></td>
            </tr>
