...
namespace PR.PRProcess.HK_CPR_NONFOOD
{
    public partial class ReportList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //rpt.Source = string.Format("BizDB.select * from (select * from PROC_CPR_NONFOOD union select * from PROC_CPR_NONFOOD) T WHERE 1=1 AND T.SITECODE='{0}'",pcCode);
        ...
        protected void lbExport_Click(object sender, EventArgs e)
        {
            ...
            dt = ExportLogic.GetSchemaTable("HK_CPR_NONFOOD", dt);
            ExcelUtil.Export(dt);
        }
