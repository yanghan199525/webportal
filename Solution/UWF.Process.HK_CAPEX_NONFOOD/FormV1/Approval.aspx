<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="UWF.Process.HK_CAPEX_NONFOOD.Approval" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="HK_CAPEX_NONFOOD" processpefix="CPRS" tablename="PROC_HK_CAPEX_NONFOOD"
            tablenamedetail="PROC_HK_CAPEX_NONFOOD_ITEMS" runat="server"></ui:userinfo>
        <!--End main table-->
        ...
        <!--1.对Table做循环，判断单行,多行-->
        <!--1.1单行-->
        <div class="row" id="div_panel_HK_CAPEX_NONFOOD">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-title">
                        <div class="fa-title">
                            ...
                            <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.HK_CAPEX_NONFOOD") %>
                        </div>
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.SITECODE") %>:
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.SITENAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.AMOUNT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.SUPPLIERCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERNAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.SUPPLIERNAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CAPEXNUMBER" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.CAPEXNUMBER") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CONTRACTDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.CONTRACTDATE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                                  <%--  <ult:TextBox ID="fld_CONTRACTDATE" data-type='datetime' title="" onblur="checkExpression(this)" data-field="CONTRACTDATE" Variable="" ControlValue="" CssClass="form-control validate[required]" runat="server">
                                    </ult:TextBox>--%>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DEPRECIATIONDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.DEPRECIATIONDATE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell" id="div_field_APPREMARK" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.APPREMARK") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-12 col-sm-6 col-xs-12 form-cell" id="div_uploads_show" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.UPLOADS") %>:
                            </div>
                            <div class="form-field">
                                <div id="div_uploads">
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCOR" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ISCOR") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCORName" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ISCORName") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
        ...
        <!--1.2多行-->
        <!--Start Item table-->
        <div class="row" id="div_panel_HK_CAPEX_NONFOOD_Items">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.HK_CAPEX_NONFOOD_Items") %></div>
                    ...
                    <div class="panel-body">
                        <table id="tb_HK_CAPEX_NONFOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                                        <input id="tb_HK_CAPEX_NONFOOD_ITEMS_rowCount" type="text" runat="server" />
                                    </td>
                                    <td class="th_no" style="width: 50px">
                                        <%=Lang.Get("No") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ARTICLECODE") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ARTICLENAME") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.FAMILYNAME") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.PCPRICE") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ORDERQTY") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ORDERUNIT") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.AMOUNT") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.DELIVERYDATE") %>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 0px; vertical-align: middle;" type="checkbox" id="ch_needaccept" onclick="ckneedaccept_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.NEEDACCEPT") %></span>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ASSETCLASS") %>
                                        <span style='color: red'>*</span>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ACCEPTMARK") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.USEFULLIFE") %>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 0px; vertical-align: middle;" type="checkbox" id="ch_buybackterm" onclick="ckbuybackterm_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.BUYBACKTERM") %></span>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 0px; vertical-align: middle;" type="checkbox" id="ch_removable" onclick="ckremovable_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.REMOVABLE") %></span>
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_HK_CAPEX_NONFOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ASSETCLASS") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.ACCEPTMARK") %>'>
                                                <ult:DropDownList ID="fld_ACCEPTMARK" title="" onblur="checkExpression(this)" data-field="ACCEPTMARK" Variable="" CssClass="stassetclass" Filter=""  ControlValue='<%#Eval("ACCEPTMARK")%>' runat="server">
                                                    <asp:ListItem Text="" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="验收点" Value="AcceptancePoint"></asp:ListItem>
                                                    <asp:ListItem Text="质保点" Value="AssurancePoint"></asp:ListItem>
                                                </ult:DropDownList>
                                            </td>
                                            <td data-label='<%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.USEFULLIFE") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.BUYBACKTERM") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.REMOVABLE") %>'>
    ...
    <script type='text/javascript' src='Approval.js?t=9119cb80-5cf5-45f6-9d3c-20f1ed3e3166'></script>
