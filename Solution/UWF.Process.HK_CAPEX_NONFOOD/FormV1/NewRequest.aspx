...
<body>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.HK_CAPEX_NONFOOD.USEFULLIFE") %>'>
                                                <ult:DropDownList ID="fld_USEFULLIFE" title="" onblur="checkExpression(this)" data-field="USEFULLIFE" Variable="" CssClass="stassetclass" Filter="" ControlValue='<%#Eval("USEFULLIFE")%>' runat="server">
                                                    <asp:ListItem Text="" Value=""></asp:ListItem>
    ...
    <script type='text/javascript' src='Approval.js?t=9119cb80-5cf5-45f6-9d3c-20f1ed3e3167'></script>
