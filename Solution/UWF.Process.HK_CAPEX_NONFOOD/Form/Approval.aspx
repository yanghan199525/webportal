...
<body>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PROC_CAPEX_NONFOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="read_detail_PROC_PROC_CAPEX_NONFOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td data-label='<%=Lang.Get("No").Split('<')[0] %>'>
                                                ...
                                                <td>
                                                    <a onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PROC_CAPEX_NONFOOD_ITEMS',this);}return false;"
                        ...
                        <div class="padding-t-5"></div>
                            ...
                            <a onclick="addRow('tb_PROC_CAPEX_NONFOOD_ITEMS');return false;" runat="server" id="btn_PROC_CAPEX_NONFOOD_ITEMS"
    ...
    <script type='text/javascript' src='Approval.js?t=7329f438-a7f8-4176-b9bf-48fad5f3642c'></script>
</body>
</html>
