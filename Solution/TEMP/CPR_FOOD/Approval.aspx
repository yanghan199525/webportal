...
<body>
     ...
     <ui:userinfo id="UserInfo1" processtitle="CPR_FOOD" processpefix="CPRF" tablename="PROC_CPR_FOOD"
        ...
        <!--1.对Table做循环，判断单行,多行-->
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_IsPrePaid" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                <ult:Label ID="read_ISPREPAID" title="" Format=""  runat="server">
                </ult:Label>
            </div></div>
         </div>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class=" td_TAXCODE" data-label='<%=Lang.Get("PR.PRProcess.CPR_FOOD.TaxCode").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_TAXCODE" title="" data-field="TAXCODE" runat="server" Text='<%#Eval("TAXCODE")%>' Width="90%"></ult:Label>
                                            </td>
                                            ...
                                            <td class=" td_INVOICETYPE" data-label='<%=Lang.Get("PR.PRProcess.CPR_FOOD.InvoiceType").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_INVOICETYPE" title="" data-field="INVOICETYPE" runat="server" Text='<%#Eval("INVOICETYPE")%>' Width="90%"></ult:Label>
                                            </td>
    ...
    <script type='text/javascript' src='Approval.js?t=c76edbbe-0306-4ddb-ba61-3475af893e87'></script>
</body>
</html>
