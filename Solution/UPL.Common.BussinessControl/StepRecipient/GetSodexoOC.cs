...
{
    public class GetSodexoOC : GetRecipient
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override string Execute(DataTable bussData, StepSetting stepConfig)
        {
            ...
            {
                if (stepConfig.StepName == "Ordering Center Manager"|| stepConfig.StepName == "OC")
                {
...
");
                    ...
                    {
                        throw new Exception(string.Format("订购中心审批人获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                    }
                }
            }
            else
