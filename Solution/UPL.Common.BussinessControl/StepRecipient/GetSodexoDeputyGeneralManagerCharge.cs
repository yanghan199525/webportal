...
{
    public class GetSodexoDeputyGeneralManagerCharge : GetRecipient
    {
        /// <summary>
        /// 分管副总经理
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("分管副总经理获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
