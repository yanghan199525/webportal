...
{
    public class GetSodexoSupplyChainLeader : GetRecipient
    {
        /// <summary>
        /// 供应链主管
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("供应链主管获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
