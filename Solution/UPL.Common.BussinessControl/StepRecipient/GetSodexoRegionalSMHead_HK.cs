...
{
    /// <summary>
    ///  香港亚太区供应链总监  Regional Head of SM 
    /// </summary>
    public class GetSodexoRegionalSMHead_HK : GetRecipient
    {
        /// <summary>
        /// 
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("亚太区供应链总监获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
