...
{
    public class GetSodexoGeneralManager : GetRecipient
    {
        /// <summary>
        /// 总经理
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("总经理获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
