...
{
    public class GetSodexoSourcingManager : GetRecipient
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override string Execute(DataTable bussData, StepSetting stepConfig)
        {
            ...
            string familyCode = ConvertUtil.ToString(bussData.Rows[0]["CPRFAMILYCODE"]);
...
select APPROVER from PROC_PROCESSSTEPAPPROVER where ProcessName=@processName and StepName=@StepName and ext01=@compCode and ext02=@familyCode;
");
                using (DbCommand cmd = db.CreateCommand())
                {
                    ...
                    db.AddInParameter(cmd, "@familyCode", DbType.String, familyCode);
