...
{
    public class GetSodexoTD : GetRecipient
    {
        /// <summary>
        /// 获取 Territory Director 
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("DT获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
