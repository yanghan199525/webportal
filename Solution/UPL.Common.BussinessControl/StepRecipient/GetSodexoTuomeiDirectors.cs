...
{
    public class GetSodexoTuomeiDirectors : GetRecipient
    {
        /// <summary>
        /// 拓美董事会
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("拓美董事会获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
