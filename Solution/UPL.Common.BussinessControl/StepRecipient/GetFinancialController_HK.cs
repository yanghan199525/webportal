...
namespace UPL.Common.BussinessControl.StepRecipient
{
    ...
    /// <summary>
    /// 获取香港的HongKong Financial controller 
    /// </summary>
    class GetFinancialController_HK : GetRecipient
    {
...
");
                ...
                {
                    throw new Exception(string.Format("财务总监获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
