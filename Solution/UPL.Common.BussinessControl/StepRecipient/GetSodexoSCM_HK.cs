...
{
    /// <summary>
    /// 获取香港供应链总监 Country Head of SM 
    /// </summary>
    public class GetSodexoSCM_HK : GetRecipient
    {
        /// <summary>
        /// 
        /// </summary>
...
");
                ...
                {
                    throw new Exception(string.Format("供应管理总监获取失败：分店编号{0},请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
