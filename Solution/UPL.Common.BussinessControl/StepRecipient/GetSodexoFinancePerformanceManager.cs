...
namespace UPL.Common.BussinessControl.StepRecipient
{
    ...
    /// 获取索迪斯采购经理审批人（单内流程）
    /// </summary>
    public class GetSodexoFinancePerformanceManager : GetRecipient
    {
...
");
                ...
                {
                    throw new Exception(string.Format("绩效经理审批人不存在：分店编号{0}请联系管理员！", ConvertUtil.ToString(bussData.Rows[0]["SITECODE"])));
                }
            }
            else
            {
