...
namespace UPL.Common.BussinessControl
{
    public class ExcelHelper
    {
        ...
        public static MemoryStream Export(DataTable dtSource, string strHeaderText, string strSheetName, string[] oldColumnNames, string[] newColumnNames)
        {
            ...
            //    }                                       //填加xls文件作者信息      
            //    si.ApplicationName = "NPOI";            //填加xls文件创建程序信息      
            //    si.LastAuthor = "BPM 系统";           //填加xls文件最后保存者信息      
            //    si.Comments = "BPM 系统自动创建文件";      //填加xls文件作者信息      
            //    si.Title = strHeaderText;               //填加xls文件标题信息      
            //    si.Subject = strHeaderText;              //填加文件主题信息      
            //    si.CreateDateTime = DateTime.Now;
            //    workbook.SummaryInformation = si;
        ...
        public static void ExportByWeb(DataTable dtSource, string strHeaderText, string strFileName, string strSheetName, string[] oldColumnNames, string[] newColumnNames)
        {
            ...
            curContext.Response.Write("<script>window.opener=null;window.close();</script>");
        }
        ...
        public DataTable Import(string strFileName)
        {
            ...
            if (Path.GetExtension(strFileName).ToLower() == ".xls".ToLower())
            {
                #region .xls文件处理
        ...
        public static DataTable RenderDataTableFromExcel_X(Stream ExcelFileStream, int SheetIndex, int HeaderRowIndex)
        {
                        ...
                        else
                        {
                            ...
                            switch (cell.CellType)
                            {
                                ...
                                case CellType.Numeric:
                                    ...
                                    {
                                        dataRow[j] = cell.DateCellValue.Date.ToString("yyyy/MM/dd");
                                    }
                                    else
                                    {
                                ...
                                case CellType.Formula:
                                    //execl 公式表达式控制
                                    switch (cell.CachedFormulaResultType.ToString())
                                    {
                                        case "Blank":
                                            dataRow[j] = null;
                                            break;
