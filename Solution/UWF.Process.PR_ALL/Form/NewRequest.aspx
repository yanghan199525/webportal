   ...
   tablenamedetail="PROC_PR_ALL_ITEMS" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height:">
             <div class="form-label">
                 <%=Lang.Get("UWF.Process.PR_ALL.SITECODE") %>:
             </div>
                                ...
                                <ult:Repeater ID="fld_detail_PROC_PR_ALL_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td class=" td_ARTICLECODE" data-label='<%=Lang.Get("UWF.Process.PR_ALL.ARTICLECODE").Split('<')[0] %>'>
    ...
    <script type='text/javascript' src='NewRequest.js?t=d3b61a6c-7cd7-4118-8e7c-5772cfe6e9ca'></script>
</body>
</html>
