<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="UWF.Process.PR_ALL.NewRequest" %>
...
<body>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height: ">
                            ...
                            <div class="form-field">
                                <div class="form-ctl">
                                    <ult:TextBox ID="fld_AMOUNT" data-type='string' title="" onblur="" data-field="AMOUNT" Variable="AMOUNT" ControlValue="" CssClass="form-control  " runat="server">
                                    </ult:TextBox>
                                </div>
                            </div>
                        </div>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=9c3f2d9a-449d-465c-89b1-ab53b45af511'></script>
    <script type='text/javascript' src='NewRequest.js?t=0441867d-5227-49fb-b9a3-992962a7d74e'></script>
</body>
</html>
