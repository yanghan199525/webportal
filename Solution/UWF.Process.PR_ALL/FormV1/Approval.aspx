<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="UWF.Process.PR_ALL.Approval" %>
...
<head>
    ...
    <script runat="server">
        ...
        {
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_PR_ALL_ITEMS = Page.FindControl("read_detail_PROC_PR_ALL_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            read_detail_PROC_PR_ALL_ITEMS.AfterBind += new System.EventHandler(AfterBind);
            AfterLoad();
        }
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_PR_ALL_ITEMS = Page.FindControl("read_detail_PROC_PR_ALL_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if (read_detail_PROC_PR_ALL_ITEMS.Items.Count == 0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, read_detail_PROC_PR_ALL_ITEMS, 1);
            }
        }
...
<body>
    ...
    <form id="form1" runat="server">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-title">
                        <div class="fa-title">
                            ...
                            <%=Lang.Get("UWF.Process.PR_ALL.PR_ALL") %>
                        </div>
                    ...
                    <div class="panel-body form-table">
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("UWF.Process.PR_ALL.SUPPLIERCODE") %>:
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERNAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("UWF.Process.PR_ALL.SUPPLIERNAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("UWF.Process.PR_ALL.AMOUNT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
        ...
        <div class="row" id="div_panel_PR_ALL_ITEMS">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("UWF.Process.PR_ALL.PR_ALL_ITEMS") %></div>
                            ...
                            <table id="tb_PR_ALL_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <td style="" class="  td_ARTICLENAME"><%=Lang.Get("UWF.Process.PR_ALL.ARTICLENAME") %></td>
                                          <td style="" class="  td_FAMILYNAME"><%=Lang.Get("UWF.Process.PR_ALL.FAMILYNAME") %></td>
                                        <td style="" class="  td_PRICE"><%=Lang.Get("UWF.Process.PR_ALL.PRICE") %></td>
                                        <td style="" class="  td_ORDERUNIT"><%=Lang.Get("UWF.Process.PR_ALL.ORDERUNIT") %></td>
                                        <td style="" class="  td_ORDERQUANTITY"><%=Lang.Get("UWF.Process.PR_ALL.ORDERQUANTITY") %></td>
                                    </tr>
                                </thead>
                                <tbody>
                                    <ult:Repeater ID="read_detail_PROC_PR_ALL_ITEMS" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td class=" td_ARTICLENAME" data-label='<%=Lang.Get("UWF.Process.PR_ALL.ARTICLENAME").Split('<')[0] %>'>
                                                ...
                                                <td class=" td_FAMILYNAME" data-label='<%=Lang.Get("UWF.Process.PR_ALL.FAMILYNAME").Split('<')[0] %>'>
                                                ...
                                                <td class=" td_PRICE" data-label='<%=Lang.Get("UWF.Process.PR_ALL.PRICE").Split('<')[0] %>'>
                                                    <ult:Label ID="fld_PRICE" title="" data-type='string' data-field="PRICE" runat="server" Text='<%#Eval("PRICE")%>' Format="" Width="90%"></ult:Label>
                                                </td>
                                                <td class=" td_ORDERUNIT" data-label='<%=Lang.Get("UWF.Process.PR_ALL.ORDERUNIT").Split('<')[0] %>'>
                                                ...
                                                <td class=" td_ORDERQUANTITY" data-label='<%=Lang.Get("UWF.Process.PR_ALL.ORDERQUANTITY").Split('<')[0] %>'>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=cdc9a905-5368-4793-bdb3-f48bee3c1969'></script>
    <script type='text/javascript' src='Approval.js?t=d456121b-47c0-401f-8a30-1e22a7f3d6ec'></script>
</body>
</html>
