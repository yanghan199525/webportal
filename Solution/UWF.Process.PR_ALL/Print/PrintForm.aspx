<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintForm.aspx.cs" Inherits="UWF.Process.PR_ALL.PrintForm" %>
...
<body>
   ...
   tablenamedetail="PROC_PR_ALL_ITEMS" runat="server"></ui:userinfo>
                <div class="panel  "><%=Lang.Get("UWF.Process.PR_ALL.PR_ALL") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                    <tr class="">
                        <td class="tdlbl tdl_SITECODE"><%=Lang.Get("UWF.Process.PR_ALL.SITECODE") %>：</td>
                ...
                <div class="panel  "><%=Lang.Get("UWF.Process.PR_ALL.PR_ALL_ITEMS") %></div>
                <table border="1" style="width: 100%; border-collapse: collapse;">
                <tr>
                    <td style="" class=" thlbl td_ARTICLECODE"><%=Lang.Get("UWF.Process.PR_ALL.ARTICLECODE") %></td>
                </tr>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=b757bfed-73ae-4d95-850d-babc364a644a'></script>
    <script type='text/javascript' src='PrintForm.js?t=59aa82e1-29fd-45ed-9a2a-7c04ea03a86e'></script>
