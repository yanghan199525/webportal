<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrReportListAll.aspx.cs" Inherits="PR.PRProcess.OR_CPR_FOOD.OrReportListAll" %>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12 padding-b-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-field">
                            <div class="form-ctl">
                                <input type="radio" name="cpr_list" id="iscpr" value="0" checked /><span>是</span>
                                <input type="radio" id="nocpr" name="cpr_list" value="1"  />
                                <span>否</span>
                            </div>
                        </div>
                    </div>
...
<%--                        <th>申请备注
                    ...
                    <tbody>
                        <ult:Repeater ID="OR_CPR_rptList" Source="BizDB.PROC_OR_CPR_FOOD" PagerID="AspNetPager1"
                            runat="server">
                            <ItemTemplate>
                                <tr>
                                     <td>
...
<%--                                    <td>
    ...
    <script type="text/javascript">
        ...
        var url = "https://testingautosmart.sodexo-cn.com/Solution/PR.PRProcess.CPR_FOOD/Report/ReportList.aspx";
        $('input[type=radio][name=cpr_list]').click(function () {      
            window.open("https://testingautosmart.sodexo-cn.com/Solution/PR.PRProcess.CPR_FOOD/Report/ReportList.aspx?pccode=" + pccode + '&empNo=' + empNo + '&loginName=' + loginName);
            $("#nocpr").attr('checked');
             window.opener=null;
		    window.open('','_self');
	    	window.close();
