...
namespace PR.PRProcess.OR_CPR_FOOD
{
    public partial class ReportList : System.Web.UI.Page
    {
        ...
        {
            var oldCount = 200000;
            var newCount = 20000000;
            Ultimus.UWF.Form.WebControls.Repeater rpt = Page.FindControl("OR_CPR_rptList") as Ultimus.UWF.Form.WebControls.Repeater;
            ProcessFormLogic process = new ProcessFormLogic();
            rpt.Source = string.Format("BizDB.SELECT top " + oldCount + " AAA.[FORMID],AAA.[PROCESSNAME],AAA.[INCIDENT],[DOCUMENTNO],[CREATEBY],[CREATEBYACCOUNT],[CREATEBYCODE],[APPLICANT],[APPLICANTACCOUNT],[APPLICANTCODE],[REQUESTDATE],[COMPLETEDATE],[DEPARTMENT],[DEPARTMENTID],[PROCESSSUMMARY],AAA.[STATUS],[PurchasingPurpose],[IsCapex],[SITECODE],[SITENAME],[DELIVERYDATE],[SUPPLIERCODE],[SUPPLIERNAME],[POAmount],[PONetAmount],[Requirement],[APPROVEDATE],[DELIVERY],[APPROVE],[USER_SIGNEDAPPROVER],[USER_SIGNEDAPPROVER2],[USER_SIGNEDAPPROVER3],[SUPPLIERTYPE],[ONLINEORSUPERMARKET],[APPLICANTTEL],[COMPANY],[COSTCENTER],[APPREMARK],[PURCHASINGAGENT],[SIGNEDAPPROVERNUMBER],ACTION FROM ( SELECT TOP " + newCount + " * FROM(SELECT [FORMID],[PROCESSNAME],[INCIDENT],[DOCUMENTNO],[CREATEBY],[CREATEBYACCOUNT],[CREATEBYCODE],[APPLICANT],[APPLICANTACCOUNT],[APPLICANTCODE],[REQUESTDATE],[COMPLETEDATE],[DEPARTMENT],[DEPARTMENTID],[PROCESSSUMMARY],[STATUS],[PurchasingPurpose],[IsCapex],[SITECODE],[SITENAME],[DELIVERYDATE],[SUPPLIERCODE],[SUPPLIERNAME],[POAmount],[PONetAmount],[Requirement],[APPROVEDATE],[DELIVERY],[APPROVE],[USER_SIGNEDAPPROVER],[USER_SIGNEDAPPROVER2],[USER_SIGNEDAPPROVER3],[SUPPLIERTYPE],[ONLINEORSUPERMARKET],[APPLICANTTEL],[COMPANY],[COSTCENTER],[APPREMARK],[PURCHASINGAGENT],[SIGNEDAPPROVERNUMBER] FROM PROC_OR_CPR_FOOD UNION SELECT [FORMID],[PROCESSNAME],[INCIDENT],[DOCUMENTNO],[CREATEBY],[CREATEBYACCOUNT],[CREATEBYCODE],[APPLICANT],[APPLICANTACCOUNT],[APPLICANTCODE],[REQUESTDATE],[COMPLETEDATE],[DEPARTMENT],[DEPARTMENTID],[PROCESSSUMMARY],[STATUS],[PurchasingPurpose],[IsCapex],[SITECODE],[SITENAME],[DELIVERYDATE],[SUPPLIERCODE],[SUPPLIERNAME],[POAmount],[PONetAmount],[Requirement],[APPROVEDATE],[DELIVERY],[APPROVE],[USER_SIGNEDAPPROVER],[USER_SIGNEDAPPROVER2],[USER_SIGNEDAPPROVER3],[SUPPLIERTYPE],[ONLINEORSUPERMARKET],[APPLICANTTEL],[COMPANY],[COSTCENTER],[APPREMARK],[PURCHASINGAGENT],[SIGNEDAPPROVERNUMBER] FROM PROC_OR_CPR_NONFOOD )T WHERE 1 = 1 ORDER BY T.REQUESTDATE DESC) AAA,(SELECT * FROM WF_APPROVALHISTORY WHERE ID IN(SELECT TOP " + newCount + " MAX(ID) ID FROM WF_APPROVALHISTORY GROUP BY FORMID)) WF WHERE AAA.FORMID=WF.FORMID AND AAA.INCIDENT!='-1' ORDER BY AAA.REQUESTDATE DESC");

            Ultimus.UWF.Form.WebControls.Repeater cptLog = Page.FindControl("OR_CPR_LOG") as Ultimus.UWF.Form.WebControls.Repeater;
            cptLog.Source = string.Format("BizDB.SELECT top " + oldCount + " FORMID,A.PROCESSNAME,A.DOCUMENTNO,INCIDENT,SUPPLIERCODE,SUPPLIERNAME,DELIVERYDATE,REQUESTDATE,POAmount,B.result,B.errormsg,SITECODE FROM(SELECT APPLICANTCODE, FORMID, PROCESSNAME,DOCUMENTNO,INCIDENT,SITECODE,SUPPLIERCODE,SUPPLIERNAME,DELIVERYDATE,REQUESTDATE,POAmount FROM  PROC_OR_CPR_FOOD UNION  SELECT APPLICANTCODE, FORMID, PROCESSNAME,DOCUMENTNO,INCIDENT,SITECODE,SUPPLIERCODE,SUPPLIERNAME,DELIVERYDATE,REQUESTDATE,POAmount FROM  PROC_OR_CPR_NONFOOD) A,PROC_OR_LOG B WHERE A.PROCESSNAME=B.processName AND A.DOCUMENTNO=B.documentNo AND B.success='FALSE'  ORDER BY REQUESTDATE  DESC");
        }
        ...
        //    Ultimus.UWF.Form.WebControls.Repeater rpt = Page.FindControl("OR_CPR_rptList") as Ultimus.UWF.Form.WebControls.Repeater;
        //    //ProcessFormLogic process = new ProcessFormLogic();
        //    rpt.Source= string.Format("BizDB.SELECT top 200000 AAA.[FORMID],AAA.[PROCESSNAME],AAA.[INCIDENT],[DOCUMENTNO],[CREATEBY],[CREATEBYACCOUNT],[CREATEBYCODE],[APPLICANT],[APPLICANTACCOUNT],[APPLICANTCODE],[REQUESTDATE],[COMPLETEDATE],[DEPARTMENT],[DEPARTMENTID],[PROCESSSUMMARY],AAA.[STATUS],[PurchasingPurpose],[IsCapex],[SITECODE],[SITENAME],[DELIVERYDATE],[SUPPLIERCODE],[SUPPLIERNAME],[POAmount],[PONetAmount],[Requirement],[APPROVEDATE],[DELIVERY],[APPROVE],[USER_SIGNEDAPPROVER],[USER_SIGNEDAPPROVER2],[USER_SIGNEDAPPROVER3],[SUPPLIERTYPE],[ONLINEORSUPERMARKET],[APPLICANTTEL],[COMPANY],[COSTCENTER],[APPREMARK],[PURCHASINGAGENT],[SIGNEDAPPROVERNUMBER],ACTION FROM ( SELECT TOP 200000 * FROM(SELECT [FORMID],[PROCESSNAME],[INCIDENT],[DOCUMENTNO],[CREATEBY],[CREATEBYACCOUNT],[CREATEBYCODE],[APPLICANT],[APPLICANTACCOUNT],[APPLICANTCODE],[REQUESTDATE],[COMPLETEDATE],[DEPARTMENT],[DEPARTMENTID],[PROCESSSUMMARY],[STATUS],[PurchasingPurpose],[IsCapex],[SITECODE],[SITENAME],[DELIVERYDATE],[SUPPLIERCODE],[SUPPLIERNAME],[POAmount],[PONetAmount],[Requirement],[APPROVEDATE],[DELIVERY],[APPROVE],[USER_SIGNEDAPPROVER],[USER_SIGNEDAPPROVER2],[USER_SIGNEDAPPROVER3],[SUPPLIERTYPE],[ONLINEORSUPERMARKET],[APPLICANTTEL],[COMPANY],[COSTCENTER],[APPREMARK],[PURCHASINGAGENT],[SIGNEDAPPROVERNUMBER] FROM PROC_OR_CPR_FOOD UNION SELECT [FORMID],[PROCESSNAME],[INCIDENT],[DOCUMENTNO],[CREATEBY],[CREATEBYACCOUNT],[CREATEBYCODE],[APPLICANT],[APPLICANTACCOUNT],[APPLICANTCODE],[REQUESTDATE],[COMPLETEDATE],[DEPAR" +
        //        "TMENT],[DEPARTMENTID],[PROCESSSUMMARY],[STATUS],[PurchasingPurpose],[IsCapex],[SITECODE],[SITENAME],[DELIVERYDATE],[SUPPLIERCODE],[SUPPLIERNAME],[POAmount],[PONetAmount],[Requirement],[APPROVEDATE],[DELIVERY],[APPROVE],[USER_SIGNEDAPPROVER],[USER_SIGNEDAPPROVER2],[USER_SIGNEDAPPROVER3],[SUPPLIERTYPE],[ONLINEORSUPERMARKET],[APPLICANTTEL],[COMPANY],[COSTCENTER],[APPREMARK],[PURCHASINGAGENT],[SIGNEDAPPROVERNUMBER] FROM PROC_OR_CPR_NONFOOD )T WHERE 1 = 1 ORDER BY T.REQUESTDATE DESC) AAA,(SELECT * FROM WF_APPROVALHISTORY WHERE ID IN(SELECT TOP 200000 MAX(ID) ID FROM WF_APPROVALHISTORY GROUP BY FORMID)) WF WHERE AAA.FORMID=WF.FORMID AND AAA.INCIDENT!='-1' ORDER BY AAA.REQUESTDATE DESC");
        //}
        protected void OR_CPR_lbExport_Click(object sender, EventArgs e)
        {
            Ultimus.UWF.Form.WebControls.Repeater rpt = Page.FindControl("OR_CPR_rptList") as Ultimus.UWF.Form.WebControls.Repeater;
            ...
            dt=ExportLogic.GetSchemaTable("OR_CPR_FOOD", dt);
            ExcelUtil.Export(dt);
        }
        protected void OR_CPR_lbHastenWork_Click(object sender, EventArgs e)
        {
            ...
            {
                if (action.Contains("拒绝"))
                {
                    string msg = "单外采购申请【" + documentno + "】状态为已拒绝，无法催办" + "\\n" + "The status of CPR[" + documentno + "] is returned,cannot be urged";
