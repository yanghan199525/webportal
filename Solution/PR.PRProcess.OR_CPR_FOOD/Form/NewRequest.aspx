<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="PR.PRProcess.OR_CPR_FOOD.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_OR_CPR_FOOD_ITEMS = Page.FindControl("fld_detail_PROC_OR_CPR_FOOD_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_OR_CPR_FOOD_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_OR_CPR_FOOD_ITEMS = Page.FindControl("fld_detail_PROC_OR_CPR_FOOD_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_OR_CPR_FOOD_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_OR_CPR_FOOD_ITEMS,1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="OR_CPR_FOOD" processprefix="OR_CPR" tablename="PROC_OR_CPR_FOOD"
   tablenamedetail="PROC_OR_CPR_FOOD_ITEMS" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_POAmount" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_POAMOUNT" data-type='string'  title="" onblur="checkExpression(this)" data-field="POAMOUNT"   Variable="POAMOUNT" ControlValue="" CssClass="form-control ReadOnly" runat="server">
                    </ult:textbox>
             </div></div>
         </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="tb_OR_CPR_FOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            ...
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_OR_CPR_FOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                          ...
                                          <%--  <td class=" td_TAXRATE" data-label='<%=Lang.Get("PR.PRProcess.OR_CPR_FOOD.TaxRate").Split('<')[0] %>'>
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_OR_CPR_FOOD_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_OR_CPR_FOOD_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=26e31c58-5957-4f22-9dd9-00a575f7a7fd'></script>
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
             ...
             $("#tb_OR_CPR_FOOD_ITEMS").find("thead").find("td:last").addClass("hidden");
             $("#tb_OR_CPR_FOOD_ITEMS").find("tbody").find("td:last").addClass("hidden");
