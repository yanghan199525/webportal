...
<body>
    ...
    <form id="form1" runat="server">
     ...
     <ui:userinfo id="UserInfo1" processtitle="OR_CPR_FOOD" processpefix="OR_CPR" tablename="PROC_OR_CPR_FOOD"
        ...
        <!--1.对Table做循环，判断单行,多行-->
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DOCUMENTNO" style="display:none;">
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DELIVERYDATE" style="height:1px">
             <div class="form-label">
    ...
    <script type='text/javascript' src='Approval.js?t=0270378e-4c85-4515-83e9-e0ae5ass7afc'></script>
