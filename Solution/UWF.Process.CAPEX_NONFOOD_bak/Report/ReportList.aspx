...
<head>
    ...
    <title>CAPEX_NONFOOD Report</title>
...
<body>
            ...
            <div class="app-page-title" style="height: 5rem; margin: 0; padding: 0;">
                <div class="page-title-wrapper pl-3 pr-3 mr-3" style="height: 4.5rem;">
                    <div class="page-title-heading">
                        ...
                        <div>
                            <div class="page-title-subheading"><h4>CAPEX_NONFOOD <%= Lang.Get("Report") %></h4></div>
                        </div>
                    </div>
                ...
                <div class="card-body pb-2">
                                    ...
                                    <ult:TextBox ID="txt_APPLICANT" runat="server" CssClass="form-control" Destination="APPLICANT"></ult:TextBox>
                                            ...
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                                                    ...
                                                    <ult:TextBox ID="txt_AMOUNT" runat="server" CssClass="form-control" Destination="AMOUNT"></ult:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="position-relative form-group">
                    ...
                    <div style="width: 100%; overflow-x: scroll;">
                        <table id="detailTable" class="table table-hover table-striped table-bordered mt-3">
                            <thead>
                                <tr>
                                    ...
                                    <th style="text-align: center; width: 90px">
                                        ...
                                        <th nowrap="nowrap" style="min-width:100px;text-align:center;">
                                            <%=Lang.Get("UWF.Process.CAPEX_NONFOOD.DOCUMENTNO") %>
                                        </th>
                                        <th nowrap="nowrap" style="min-width:100px;text-align:center;">
                                            <%=Lang.Get("UWF.Process.CAPEX_NONFOOD.SupplierCode") %>
                                        </th>
                            ...
                            <tbody>
                                <ult:Repeater ID="rptList" OnItemCommand="rpSource_ItemCommand" Source="BizDB.PROC_CAPEX_NONFOOD" PagerID="AspNetPager1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <%# Eval("REQUESTDATE")!=DBNull.Value?String.Format("{0:yyyy-MM-dd}", MyLib.ConvertUtil.ToDateTime(Eval("REQUESTDATE"))):""%>
                                                    ...
                                                    <td data-toggle="tooltip" data-placement="bottom" title='<%#Eval("DOCUMENTNO")%>'>
                                                        <%# WriteContext(Eval("DOCUMENTNO"))%>
                                                    </td>
    ...
    <script type='text/javascript' src='ReportList.js?t=638835053552304144'></script>
</body>
