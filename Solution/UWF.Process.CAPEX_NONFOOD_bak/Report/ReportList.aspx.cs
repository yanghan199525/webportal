...
namespace UWF.Process.CAPEX_NONFOOD
{
    ...
    rpt.Source = "BizDB.select * from PROC_CAPEX_NONFOOD where 1=1 "+process.GetReportViewSql    ("CAPEX_NONFOOD",SessionLogic.GetLoginName());
    ...
    //dt=ExportLogic.GetExportTable("CAPEX_NONFOOD");
    ExcelUtil.Export(dt);
    }
