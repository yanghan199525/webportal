<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="UWF.Process.CAPEX_ALL.Approval" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
        <ui:userinfo id="UserInfo1" processtitle="CAPEX_ALL" processpefix="CPRS" tablename="PROC_CAPEX_ALL"
        ...
        <!--1.对Table做循环，判断单行,多行-->
        <!--1.1单行-->
        <div class="row" id="div_panel_CAPEX_ALL">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-title">
                        <div class="fa-title">
                            ...
                            <%=Lang.Get("PR.PRProcess.CAPEX_ALL.CAPEX_ALL") %>
                        </div>
                    ...
                    <div class="panel-body form-table">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.SITECODE") %>:
                            </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITENAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.SITENAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_AMOUNT" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.AMOUNT") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERCODE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.SUPPLIERCODE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SUPPLIERNAME" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.SUPPLIERNAME") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CAPEXNUMBER" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.CAPEXNUMBER") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_CONTRACTDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.CONTRACTDATE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_DEPRECIATIONDATE" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.DEPRECIATIONDATE") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-12 col-sm-6 col-xs-12 form-cell" id="div_uploads_show" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.UPLOADS") %>:
                            </div>
                            <div class="form-field">
                                <div id="div_uploads">
                                </div>
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCOR" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ISCOR") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
                        ...
                        <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_ISCORName" style="height: ">
                            <div class="form-label">
                                <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ISCORName") %>:
                            </div>
                            <div class="form-field">
                                <div class="form-ctl">
        ...
        <!--1.2多行-->
        <!--Start Item table-->
        <div class="row" id="div_panel_CAPEX_ALL_Items">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-title">
                        <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("PR.PRProcess.CAPEX_ALL.CAPEX_ALL_Items") %></div>
                    ...
                    <div class="panel-body">
                        <table id="tb_CAPEX_ALL_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                                        <input id="tb_CAPEX_ALL_ITEMS_rowCount" type="text" runat="server" />
                                    </td>
                                    <td class="th_no" style="width: 50px">
                                        <%=Lang.Get("No") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ARTICLECODE") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ARTICLENAME") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.FAMILYNAME") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.PCPRICE") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ORDERQTY") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ORDERUNIT") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.AMOUNT") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.DELIVERYDATE") %>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 0px; vertical-align: middle;" type="checkbox" id="ch_needaccept" onclick="ckneedaccept_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.CAPEX_ALL.NEEDACCEPT") %></span>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ASSETCLASS") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.ACCEPTMARK") %>
                                    </td>
                                    <td>
                                        <%=Lang.Get("PR.PRProcess.CAPEX_ALL.USEFULLIFE") %>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 0px; vertical-align: middle;" type="checkbox" id="ch_buybackterm" onclick="ckbuybackterm_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.CAPEX_ALL.BUYBACKTERM") %></span>
                                    </td>
                                    <td style="text-align: left; vertical-align: middle;">
                                        <input style="cursor: pointer; margin-right: 0px; vertical-align: middle;" type="checkbox" id="ch_removable" onclick="ckremovable_click()" name="checkBox" /><span style="vertical-align: middle;"><%=Lang.Get("PR.PRProcess.CAPEX_ALL.REMOVABLE") %></span>
                                    </td>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_CAPEX_ALL_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.CAPEX_ALL.ASSETCLASS") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.CAPEX_ALL.ACCEPTMARK") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.CAPEX_ALL.USEFULLIFE") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.CAPEX_ALL.BUYBACKTERM") %>'>
                                            ...
                                            <td data-label='<%=Lang.Get("PR.PRProcess.CAPEX_ALL.REMOVABLE") %>'>
