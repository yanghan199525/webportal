<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="UWF.Process.MCPR_SERVICE.ReportList" %>
...
<head>
    ...
    <title>MCPR_SERVICE Report</title>
            ...
            <div class="app-page-title" style="height: 5rem; margin: 0; padding: 0;">
                <div class="page-title-wrapper pl-3 pr-3 mr-3" style="height: 4.5rem;">
                    <div class="page-title-heading">
                        ...
                        <div>
                            <div class="page-title-subheading"><h4>MCPR_SERVICE <%= Lang.Get("Report") %></h4></div>
                        </div>
                    </div>
                ...
                <div class="card-body pb-2">
                    ...
                    <div style="width: 100%; overflow-x: scroll;">
                        <table id="detailTable" class="table table-hover table-striped table-bordered mt-3">
                            ...
                            <tbody>
                                <ult:Repeater ID="rptList" OnItemCommand="rpSource_ItemCommand" Source="BizDB.PROC_MCPR_SERVICE" PagerID="AspNetPager1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
