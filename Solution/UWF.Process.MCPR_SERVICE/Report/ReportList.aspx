<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportList.aspx.cs" Inherits="UWF.Process.MMCPR_SERVICE.ReportList" %>
...
<head>
    ...
    <title>MMCPR_SERVICE Report</title>
...
<body>
            ...
            <div class="app-page-title" style="height: 5rem; margin: 0; padding: 0;">
                <div class="page-title-wrapper pl-3 pr-3 mr-3" style="height: 4.5rem;">
                    <div class="page-title-heading">
                        ...
                        <div>
                            <div class="page-title-subheading"><h4>MMCPR_SERVICE <%= Lang.Get("Report") %></h4></div>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <th style="text-align: center; width: 90px">
                                        ...
                                        <th nowrap="nowrap" style="min-width:100px;text-align:center;">
                                            <%=Lang.Get("UWF.Process.MMCPR_SERVICE.SITECODE") %>
                                        </th>
                                    <th>PDF</th>
                                </tr>
                            </thead>
                            <tbody>
                                <ult:Repeater ID="rptList" OnItemCommand="rpSource_ItemCommand" Source="BizDB.PROC_MMCPR_SERVICE" PagerID="AspNetPager1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
    ...
    <script type='text/javascript' src='ReportList.js?t=639223106261861945'></script>
</body>
