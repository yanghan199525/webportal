<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="UWF.Process.MCPR_SERVICE.Approval" %>
...
<head>
    ...
    <script runat="server">
        ...
        {
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_MCPR_SERVICE_ITEMS = Page.FindControl("read_detail_PROC_MCPR_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            read_detail_PROC_MCPR_SERVICE_ITEMS.AfterBind += new System.EventHandler(AfterBind);
            AfterLoad();
        }
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater read_detail_PROC_MCPR_SERVICE_ITEMS = Page.FindControl("read_detail_PROC_MCPR_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(read_detail_PROC_MCPR_SERVICE_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, read_detail_PROC_MCPR_SERVICE_ITEMS,1);
            }
        }
   ...
   tablenamedetail="PROC_MCPR_SERVICE_ITEMS" runat="server"></ui:userinfo>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-title">
                            <div class="fa-title">
                                ...
                                <%=Lang.Get("UWF.Process.MCPR_SERVICE.MCPR_SERVICE") %>
                            </div>
                        ...
                        <div class="panel-body form-table">
                                <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_SITECODE" style="height:">
                                        ...
                                        <%=Lang.Get("UWF.Process.MCPR_SERVICE.SITECODE") %>:
                                    </div>
            ...
            <div class="row" id="div_panel_MCPR_SERVICE_ITEMS">
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-title">
                            <div class="fa-title"><i class="fa fa-bars"></i><span class="padding-r-5"></span><%=Lang.Get("UWF.Process.MCPR_SERVICE.MCPR_SERVICE_ITEMS") %></div>
                        ...
                        <div class="panel-body">
                            <div class="inputContainer padding-t-5" style="width:100%">
                                <!--Start detail table-->
                                <table id="tb_MCPR_SERVICE_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table" width="100%">
                                    <thead>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td style="width: 50px">
                                                ...
                                                <td style=""  class="  td_ARTICLECODE"><%=Lang.Get("UWF.Process.MCPR_SERVICE.ARTICLECODE") %></td>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class=" td_ARTICLECODE" data-label='<%=Lang.Get("UWF.Process.MCPR_SERVICE.ARTICLECODE").Split('<')[0] %>'>
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=02a7dcc4-97d5-438c-b128-f1583fc80cf7'></script>
    <script type='text/javascript' src='Approval.js?t=33f6144c-15e4-4a59-9d93-046f1b9eb1bd'></script>
</body>
</html>
