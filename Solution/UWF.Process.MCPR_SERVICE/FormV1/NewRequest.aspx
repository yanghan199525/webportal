...
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="MCPR_SERVICE" processprefix="" tablename="PROC_MCPR_SERVICE"
   tablenamedetail="PROC_MCPR_SERVICE_ITEMS" runat="server"></ui:userinfo>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <td class=" td_ARTICLECODE" data-label='<%=Lang.Get("UWF.Process.MCPR_SERVICE.ARTICLECODE").Split('<')[0] %>'>
                                            ...
                                            <td>
                                                <a onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_MCPR_SERVICE_ITEMS',this);}return false;"
                            ...
                            <a onclick="addRow('tb_MCPR_SERVICE_ITEMS');return false;" runat="server" id="btn_MCPR_SERVICE_ITEMS"
    ...
    <script type='text/javascript' src='<%=WebUtil.GetRootPath()%>/Solution/UPL.Common.BussinessControl/Script/BussinessCommon.js?t=c044103b-cae5-4b21-a4a7-048c42c49069'></script>
    <script type='text/javascript' src='NewRequest.js?t=ec59d287-f952-4227-a652-98dc86fab0dd'></script>
</body>
</html>
