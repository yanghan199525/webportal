...
namespace UWF.Process.HK_CAPEX_SERVICE
{
    public partial class NewRequest : System.Web.UI.Page
    {
        ...
        protected void AfterLoad()
        {
            ...
            if (procType.ToUpper().Trim() == "REPORT")
            {
                ...
                string url = string.Format("{4}/Solution/PR.PRProcess.HK_CAPEX_SERVICE/Form/NewRequest.aspx?ProcessName=HK_CAPEX_SERVICE&StepName=Begin&Incident={0}&TaskID={1}&UserName={2}&Type=MYREQUEST&ServerName=&t=&FORMID={3}&hasformid=0&t=&processStatus=1&ShowType=REPORT", Incident, TaskID, UserName, FORMID, rootPath);
        ...
        protected void NewRequest_AfterSubmit(object sender, System.ComponentModel.CancelEventArgs e)
        {
            try
            {
                ...
                if (fld_SUPPLIERTYPE.SelectedItem.Value == "9" || fld_SUPPLIERTYPE.SelectedItem.Text == "授权供应商" || fld_SUPPLIERTYPE.SelectedItem.Text == "Authorized Supplier")
                {
                    ...
                    UserInfo UserInfo = Page.FindControl("UserInfo1") as UserInfo;
                    Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_HK_CAPEX_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_HK_CAPEX_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
                    IWorkflow _workflow = ServiceContainer.Instance().GetService<IWorkflow>();
                    DataTable Article = _workflow.GetDetailData(UserInfo, fld_detail_PROC_HK_CAPEX_SERVICE_ITEMS, UserInfo.FormID);
