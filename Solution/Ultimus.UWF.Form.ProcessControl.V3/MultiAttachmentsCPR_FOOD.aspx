<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MultiAttachmentsCPR_FOOD.aspx.cs" Inherits="Ultimus.UWF.Form.ProcessControl.V3.MultiAttachmentsCPR_FOOD" %>
...
<script type="text/javascript">
    ...
    $().ready(function () {
        ...
        $("#file_upload").uploadifive({
            ...
            'uploadScript': '<%=Ultimus.UWF.Common.Logic.WebUtil.GetRootPath()%>/Solution/Ultimus.UWF.Form.ProcessControl.V3/UploadHandler.ashx?ProcessName=' + pname + '&Incident=' + incident + '&StepName=' + stepname + '&FORMID=' + formid + '&USERNAME=' + encodeURI(username),
            'width': '68',
            'height': '34',
            'multi': true,
                    ...
                    { method: "getattachment", formid: formid, type: '' }, function (data) {
                        ...
                        for (var i = 0; i < objs.length; i++) {
                            ...
                            ''+obj.CREATEBY+'</td>'+
                             ...
                             '       <td id="Attachments1_Repeater1_ctl' + parseInt(i) + '_Td1">' +
                              ' <a onclick="if(confirm(\'<%=Ultimus.UWF.Common.Logic.Lang.Get("SecurityList_ConfirmDelete")%>\')){deleteAtt(\'' + obj.NEWNAME + '\',this)}" class="btn btn-icon btn-sm" href="javascript:void(0)" ><i class="fa fa-trash"></i></a>         ' +
                              '      </td>'+
