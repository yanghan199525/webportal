<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewRequest.aspx.cs" Inherits="PR.PRProcess.PRHK_SERVICE.NewRequest" %>
...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PRHK_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_PRHK_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_PRHK_SERVICE_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PRHK_SERVICE_ITEMS = Page.FindControl("fld_detail_PROC_PRHK_SERVICE_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_PRHK_SERVICE_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_PRHK_SERVICE_ITEMS,1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PRHK_SERVICE" processprefix="HKCPR" tablename="PROC_PRHK_SERVICE"
   tablenamedetail="PROC_PRHK_SERVICE_ITEMS" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVEDATE" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="fld_APPROVEDATE" data-type='string'  title="" onblur="checkExpression(this)" data-field="APPROVEDATE"   Variable="" ControlValue="" CssClass="form-control   ReadOnly" runat="server">
                    </ult:textbox>
             </div></div>
         </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PRHK_SERVICE_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_PRHK_SERVICE_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PRHK_SERVICE_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_PRHK_SERVICE_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=2e43c3b5-68ac-456f-92e8-50d0a86844c6'></script>
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
             ...
             $("#tb_PRHK_SERVICE_ITEMS").find("thead").find("td:last").addClass("hidden");
             $("#tb_PRHK_SERVICE_ITEMS").find("tbody").find("td:last").addClass("hidden");
