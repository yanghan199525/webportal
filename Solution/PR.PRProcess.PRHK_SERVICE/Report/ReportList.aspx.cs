...
namespace PR.PRProcess.PRHK_SERVICE
{
    public partial class ReportList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            rpt.Source = "BizDB.select * from PROC_PRHK_SERVICE where 1=1 " + process.GetReportViewSql("PRHK_SERVICE",SessionLogic.GetLoginName());
        }
        protected void lbExport_Click(object sender, EventArgs e)
        {
            ...
            dt=ExportLogic.GetSchemaTable("PRHK_SERVICE", dt);
            ExcelUtil.Export(dt);
        }
    }
}