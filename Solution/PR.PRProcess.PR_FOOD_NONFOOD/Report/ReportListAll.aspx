<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReportListAll.aspx.cs" Inherits="PR.PRProcess.PR_FOOD_NONFOOD.ReportListAll" %>
...
<head>
    ...
    <title>PR_FOOD_NONFOOD Report</title>
    ...
    <form id="form1" runat="server">
        <div class="panel panel-default">
            ...
            <div class="pull-right">
             ...
             <div class="panel-heading padding-t-5 padding-b-15">
                <span class="f-bold padding-l-5"><i class="fa fa-th-list"></i>
                    单内审批生成失败记录/PR Generate Failed Record</span>
            </div>
            <div class="padding-l-5 padding-r-5">
                <table class="table table-condensed table-bordered ">
                    <thead>
                    ...
                    <tbody>
                        <ult:Repeater ID="ImportFailedRecord" Source=" " PagerID="AspNetPager2"
                            runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td>
