...
<head>
    ...
    <script runat="server">
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS = Page.FindControl("fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS.AfterBind += new System.EventHandler(AfterBind);
        ...
        void AfterBind(object sender, EventArgs e)
        {
            ...
            Ultimus.UWF.Form.WebControls.Repeater fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS = Page.FindControl("fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS") as Ultimus.UWF.Form.WebControls.Repeater;
            if(fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS.Items.Count==0)
            {
                UserInfo userInfo1 = Page.FindControl("UserInfo1") as UserInfo;
                _form.AddBlankRow(userInfo1, fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS,1);
            }
        }
    </script>
</head>
<body>
    ...
    <form id="form1" runat="server">
        <!--定义UserInfo-->
            <ui:userinfo id="UserInfo1" processtitle="PR_FOOD_NONFOOD" processprefix="PR" tablename="PROC_PR_FOOD_NONFOOD"
   tablenamedetail="PROC_PR_FOOD_NONFOOD_ITEMS" runat="server"></ui:userinfo>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_PurchasingPurpose" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <asp:Label ID="txt_PURCHASINGPURPOSE" title="" runat="server">
                    </asp:Label>
             </div></div>
         </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_Requirement" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                     <asp:Label ID="txt_REQUIREMENT" title="e" runat="server">
                    </asp:Label>
             </div></div>
         </div>
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell hidden" id="div_field_APPROVE" style="height:">
             ...
             <div class="form-label">
                 <%=Lang.Get("PR.PRProcess.PR_FOOD_NONFOOD.ISCOR") %>:
             </div>
             <div class="form-field"><div class="form-ctl">
                     <ult:TextBox ID="TextBox1" data-type='string'  title="" onblur="checkExpression(this)" data-field="ISCOR"   Variable="ISCOR" ControlValue="" CssClass="form-control  " runat="server">
                    </ult:textbox>
             </div></div>
         </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <!--Start detail table-->
                        <table id="tb_PR_FOOD_NONFOOD_ITEMS" class="table table-bordered table-condensed form-detail-table form-resp-table tablerequired" width="100%">
                            <thead>
                                <tr>
                                    <td class="hidden">
                            ...
                            <tbody>
                                <ult:Repeater ID="fld_detail_PROC_PR_FOOD_NONFOOD_ITEMS" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td class="hidden">
                                            ...
                                            <td>
                                                <button onclick="if(confirm('<%=Lang.Get("SecurityList_ConfirmDelete") %>？')){deleteRow('tb_PR_FOOD_NONFOOD_ITEMS',this);}return false;"
                        ...
                        <button onclick="addRow('tb_PR_FOOD_NONFOOD_ITEMS');return false;"
    ...
    <script type='text/javascript' src='NewRequest.js?t=68a860e0-0c28-424f-8923-54c198b07235'></script>
    ...
    $("#UserInfo1_read_DEPARTMENT").parent("div").parent("div").parent("div").hide();
             ...
             $("#tb_PR_FOOD_NONFOOD_ITEMS").find("thead").find("td:last").addClass("hidden");
             $("#tb_PR_FOOD_NONFOOD_ITEMS").find("tbody").find("td:last").addClass("hidden");
