<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Approval.aspx.cs" Inherits="PR.PRProcess.PR_FOOD_NONFOOD.Approval" %>
...
<body>
     ...
     <ui:userinfo id="UserInfo1" processtitle="PR_FOOD_NONFOOD" processpefix="PR" tablename="PROC_PR_FOOD_NONFOOD"
        ...
        <!--1.对Table做循环，判断单行,多行-->
         ...
         <div class="col-lg-4 col-sm-6 col-xs-12 form-cell " id="div_field_Requirement" style="height:">
             ...
             <div class="form-field"><div class="form-ctl">
                <ult:Label ID="read_REQUIREMENT" title="e" Format=""  runat="server">
                </ult:Label>
            </div></div>
         </div>
    ...
    <script type='text/javascript' src='Approval.js?t=b7652768-70bc-490d-8c2c-84692f32becc'></script>
